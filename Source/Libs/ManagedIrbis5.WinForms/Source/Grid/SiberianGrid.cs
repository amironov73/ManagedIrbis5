    ...
    : Control
{
    ...
    private int _DoScroll
        (
            ScrollBar? scrollBar,
            ScrollEventArgs eventArgs
        )
    {
        var result = eventArgs.OldValue;
        ...
        )
    {
        ...
        if (CurrentColumn is null || CurrentColumn.ReadOnly)
        {
            return null;
        }
