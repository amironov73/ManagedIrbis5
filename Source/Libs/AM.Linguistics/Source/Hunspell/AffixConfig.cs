...
public sealed partial class AffixConfig
{
    ...
    private readonly AffixConfigOptions options;
    ...
    /// </remarks>
    public FlagMode FlagMode { get; private init; }
    ...
    public bool CheckCompoundRep { get; private init; }
    ...
    public bool CheckCompoundTriple { get; private init; }
    ...
    public bool OnlyMaxDiff { get; private init; }

    /// <summary>
    /// Disable word suggestions with spaces.
    /// </summary>
    /// <seealso cref="AffixConfigOptions.NoSplitSuggestions"/>
    public bool NoSplitSuggestions { get; private init; }
    ...
    public bool FullStrip { get; private init; }
    ...
    public bool SuggestWithDots { get; private init; }
    ...
    public bool ForbidWarn { get; private init; }
    ...
    public bool CheckSharps { get; private init; }

    /// <summary>
    /// Indicates that simplified coumpounds are enabled.
    /// </summary>
    public bool SimplifiedCompound { get; private init; }
    ...
    /// </remarks>
    public string? TryString { get; private init; }
    ...
    /// </summary>
    public StringComparer? StringComparer { get; private init; }
    ...
    /// </remarks>
    public FlagValue CompoundFlag { get; private init; }
    ...
    /// </remarks>
    public FlagValue CompoundBegin { get; private init; }
    ...
    /// </remarks>
    public FlagValue CompoundEnd { get; private init; }
    ...
    /// </remarks>
    public FlagValue CompoundMiddle { get; private init; }
    ...
    /// </remarks>
    public int? CompoundWordMax { get; private init; }
    ...
    /// </remarks>
    public int CompoundMin { get; private init; }
    ...
    /// </remarks>
    public FlagValue CompoundRoot { get; private init; }
    ...
    /// </remarks>
    public FlagValue CompoundPermitFlag { get; private init; }
    ...
    /// </remarks>
    public FlagValue CompoundForbidFlag { get; private init; }
    ...
    public FlagValue NoSuggest { get; private init; }
    ...
    public FlagValue NoNgramSuggest { get; private init; }
    ...
    /// </remarks>
    public FlagValue ForbiddenWord { get; private init; }
    ...
    /// </remarks>
    public FlagValue LemmaPresent { get; private init; }
    ...
    /// </remarks>
    public FlagValue Circumfix { get; private init; }
    ...
    /// by itself.
    /// </remarks>
    public FlagValue OnlyInCompound { get; private init; }
    ...
    /// </remarks>
    public FlagValue NeedAffix { get; private init; }

    /// <summary>
    /// Maximum number of n-gram suggestions. A value of 0 switches off the n-gram suggestions.
    /// </summary>
    /// <seealso cref="MaxDifferency"/>
    public int MaxNgramSuggestions { get; private init; }
    ...
    public int? MaxDifferency { get; private init; }
    ...
    /// distance type.
    /// </remarks>
    public int MaxCompoundSuggestions { get; private init; }
    ...
    /// </para>
    /// </remarks>
    public FlagValue KeepCase { get; private init; }
    ...
    /// names.
    /// </remarks>
    public FlagValue ForceUpperCase { get; private init; }
    ...
    public FlagValue Warn { get; private init; }
    ...
    /// </remarks>
    /// <seealso cref="NoSuggest"/>
    public FlagValue SubStandard { get; private init; }
    ...
    /// </remarks>
    public string? CompoundSyllableNum { get; private init; }
    ...
    public SingleReplacementSet? Replacements { get; private init; }
    ...
    /// </para>
    /// </remarks>
    public CompoundRuleSet? CompoundRules { get; private init; }
    ...
    /// </code>
    /// </example>
    public PatternSet? CompoundPatterns { get; private init; }
    ...
    public BreakSet? BreakPoints { get; private init; }
    ...
    /// </example>
    /// <seealso cref="Replacements"/>
    public MapTable? RelatedCharacterMap { get; private init; }
    ...
    /// </para>
    /// </remarks>
    public PhoneTable? Phone { get; private init; }
    ...
    public int CompoundMaxSyllable { get; private init; }

    /// <summary>
    /// Voewls for calculating syllables.
    /// </summary>
    /// <seealso cref="CompoundMaxSyllable"/>
    public CharacterSet? CompoundVowels { get; private init; }
    ...
    /// </remarks>
    public CharacterSet? WordChars { get; private init; }
    ...
    /// </remarks>
    public CharacterSet? IgnoredChars { get; private init; }
    ...
    ///
    /// </summary>
    public bool IsHungarian { get; private init; }

    /// <summary>
    ///
    /// </summary>
    public bool IsGerman { get; private init; }
    ...
    /// </remarks>
    public bool IsLanguageWithDashUsage { get; private init; }

    /// <summary>
    ///
    /// </summary>
    public bool CultureUsesDottedI { get; private init; }

    /// <summary>
    ///
    /// </summary>
    public WarningList? Warnings { get; private init; }
