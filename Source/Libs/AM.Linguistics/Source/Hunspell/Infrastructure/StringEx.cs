    ...
    internal static class StringEx
    {
        ...
        public static string GetReversed (this string @this)
        {
            ...
            using (var mo = MemoryPool<char>.Shared.Rent (@this.Length))
            {
                ...
                for (var i = 0; i < buffer.Length; i++) buffer[i] = @this[lastIndex - i];
        ...
        public static string ConcatString (string str0, int startIndex0, int count0, string str1, char char2,
