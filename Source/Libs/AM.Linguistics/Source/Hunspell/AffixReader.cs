...
public sealed class AffixReader
{
    ...
    public AffixReader
        (
            AffixConfig.Builder? builder,
            IHunspellLineReader reader
        )
    {
    ...
    public static async Task<AffixConfig> ReadAsync
        (
            IHunspellLineReader reader,
            AffixConfig.Builder? builder = null
        )
    {
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException"></exception>
    public static AffixConfig Read
        (
            IHunspellLineReader reader,
            AffixConfig.Builder? builder = null
        )
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException"></exception>
    public static async Task<AffixConfig> ReadFileAsync
        (
            string filePath,
            AffixConfig.Builder? builder = null
        )
    ...
    /// <returns></returns>
    /// <exception cref="ArgumentNullException"></exception>
    public static AffixConfig ReadFile
        (
            string filePath,
            AffixConfig.Builder? builder = null
        )
    ...
    private bool TryParseStandardListItem<T>
        (
    ...
    private bool TryParseAffixIntoList<TEntry>
        (
            ReadOnlySpan<char> parameterText,
    ...
    private bool TryParseCheckCompoundPatternIntoCompoundPatterns
        (
            ReadOnlySpan<char> parameterText,
    ...
    private static ReadOnlySpan<char> ParseLeadingDigits
        (
    ...
    private static AffixConfigOptions? TryParseFileBitFlagCommand
        (
    ...
    private static FlagMode? TryParseFlagMode
        (
            ReadOnlySpan<char> value
        )
    {
            ...
            switch (value[0])
            {
                ...
                case 'u':
                    if (value.StartsWith ("UTF", StringComparison.OrdinalIgnoreCase) ||
                        value.StartsWith ("UNI", StringComparison.OrdinalIgnoreCase))
                    {
                        return FlagMode.Uni;
                    }
    ...
    private enum AffixReaderCommandKind
        : byte
    {
        /// <summary>
