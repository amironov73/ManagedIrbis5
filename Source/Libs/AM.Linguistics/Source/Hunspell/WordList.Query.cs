...
public partial class WordList
{
    private abstract class Query
    {
        ...
        private void SetPrefix (PrefixEntry prefix) => Prefix = prefix;

        private void SetSuffix (Affix<SuffixEntry> suffix) => Suffix = suffix;

        private void SetSuffixFlag (FlagValue flag) => SuffixFlag = flag;

        private void SetSuffixExtra (bool extra) => SuffixExtra = extra;

        private void SetSuffixAppend (string append) => SuffixAppend = append;
        ...
        private WordEntry? HomonymWordSearch
            (
                ReadOnlySpan<char> homonymWord,
        ...
        private WordEntryDetail? HomonymWordSearchDetail
            (
                string homonymWord,
                IncrementalWordList? words,
                FlagValue condition2,
        ...
        protected WordEntry? CompoundCheck
            (
                string word,
                int wordNum,
                int numSyllable,
        ...
        {
            int oldnumsyllable2, oldwordnum, oldwordnum2;
            WordEntry? rv;
            WordEntry? rvFirst;
            var ch = '\0';
                    ...
                    do // simplified checkcompoundpattern loop
                    {
...

                        {
                            ...
                            if (searchEntryDetails.Length > 0)
                            {
                                ...
                                if (rvDetail is not null && rvDetail.ContainsFlag (Affix.CompoundForbidFlag) &&
                                    !huMovRule)
                                {
                                    continue;
                                }
                        ...
                        else if (huMovRule && Affix.IsHungarian)
                        {
                            ...
                            firstWordCompoundAcceptable =
                                rv is not null
                                && Suffix is not null // XXX hardwired Hungarian dic. codes
                            ...
                            do
                            {
...

                                {
                                    ...
                                    if (rv is null && Affix.CompoundRules!.HasItems && words is not null)
                                    {
                                        ...
                                        if (rv is not null && DefCompoundCheck (words.CreateIncremented(), rv.Detail,
                                                true))
                                        {
                                            st.Destroy();
                                            return rvFirst;
        ...
        /// </summary>
        private WordEntry? AffixCheck
            (
                ReadOnlySpan<char> word,
                FlagValue needFlag,
                CompoundOptions inCompound
            )
        {
        ...
        protected WordEntry? PrefixCheckTwoSfx
            (
                string word,
                CompoundOptions inCompound,
                FlagValue needFlag
        ...
        /// </summary>
        private WordEntry? CheckTwoSfx
            (
                Affix<PrefixEntry> pe,
                string word,
                CompoundOptions inCompound,
                FlagValue needFlag
            )
        ...
        protected WordEntry? SuffixCheck
            (
                string word,
                AffixEntryOptions sfxOpts,
                Affix<PrefixEntry>? pfx,
                FlagValue cclass,
                FlagValue needFlag,
                CompoundOptions inCompound
            )
        ...
        /// </summary>
        protected WordEntry? SuffixCheckTwoSfx
            (
                string word,
                AffixEntryOptions sfxopts,
                Affix<PrefixEntry>? pfx,
        ...
        /// </summary>
        private static bool CompoundCaseCheck
            (
                string word,
                int pos
            )
        ...
        private bool CompoundReplacementCheck
            (
                ReadOnlySpan<char> wordSlice
            )
        {
        ...
        private bool CompoundWordPairCheck
            (
                ReadOnlySpan<char> wordSlice
            )
        {
        ...
        private WordEntry? CheckWordPrefix
            (
        ...
        private WordEntry? CheckWordSuffix
            (
                Affix<SuffixEntry> affix,
                string word,
                AffixEntryOptions optFlags,
                Affix<PrefixEntry>? pfx,
                FlagValue cclass,
                FlagValue needFlag,
                FlagValue badFlag
        ...
        private WordEntry? CheckTwoSfx
            (
                Affix<SuffixEntry> se,
                string word,
                AffixEntryOptions optflags,
                Affix<PrefixEntry>? ppfx,
                FlagValue needflag
            )
        {
            // if this suffix is being cross checked with a prefix
            ...
            if (EnumEx.HasFlag (optflags, AffixEntryOptions.CrossProduct) &&
                !EnumEx.HasFlag (se.Options, AffixEntryOptions.CrossProduct))
            {
                return null;
            }
        ...
        private bool CandidateCheck
            (
                string word
            )
        {
            return WordList.ContainsEntriesForRootWord (word) ||
                   AffixCheck (word, default, CompoundOptions.Not) is not null;
        }
        ...
        /// </remarks>
        protected string CleanWord2
            (
                string src,
                out CapitalizationType capType,
                out int abbv
            )
        {
