...
namespace AM.Linguistics.Hunspell
{
    public partial class WordList
    {
        private abstract class Query
        {
            ...
            {
                return EnumEx.HasFlag (info, SpellCheckResultType.InitCap) &&
            ...
            protected WordEntry CheckWord (string word, ref SpellCheckResultType info, out string root)
            {
                ...
                if (details.Length != 0)
                {
                    ...
                    if (heIndex < details.Length) return new WordEntry (word, heDetails);
                }
                ...
                if (he != null)
                {
                    ...
                    root = he.Word;
                    if (Affix.ComplexPrefixes) root = root.GetReversed();
                }
                else if (Affix.HasCompound)
                {
                    ...
                    if (he == null && word.EndsWith ('-') && Affix.IsHungarian)
                        ...
                        he = CompoundCheck (word.Substring (0, word.Length - 1), -5, 0, 100, null, rwords, true, 0,
                            ref info);
                ...
                IncrementalWordList rwords)
            {
                foreach (var searchEntryDetail in searchEntryDetails)
                    if (!searchEntryDetail.ContainsFlag (Affix.NeedAffix))
                    {
                        ...
                        if (defCpdCheck && (scpdPatternEntryCondition.IsZero ||
                ...
                FlagValue compoundPart)
            {
                foreach (var searchEntryDetail in searchEntryDetails)
                    if (
                            ...
                            &&
                            searchEntryDetail.ContainsAnyFlags (Affix.CompoundFlag, scpdPatternEntryCondition,
                                compoundPart)
                        )
                        return searchEntryDetail;
            ...
            private WordEntry HomonymWordSearch (ReadOnlySpan<char> homonymWord, IncrementalWordList words,
                FlagValue condition2, bool scpdIsZero)
            {
                var homonymWordString = homonymWord.ToString();
                return HomonymWordSearchDetail (homonymWordString, words, condition2, scpdIsZero)
                    ?.ToEntry (homonymWordString);
            }

            private WordEntryDetail HomonymWordSearchDetail (string homonymWord, IncrementalWordList words,
                FlagValue condition2, bool scpdIsZero)
            {
            ...
            protected WordEntry CompoundCheck (string word, int wordNum, int numSyllable, int maxwordnum,
                IncrementalWordList words, IncrementalWordList rwords, bool huMovRule, int isSug,
                ref SpellCheckResultType info)
            {
                ...
                var conditionBypassAllCompounds = Affix.CompoundFlag.IsZero && Affix.CompoundBegin.IsZero &&
                                                  Affix.CompoundMiddle.IsZero;
                ...
                for (var i = cmin; i < cmax; i++)
                {
                    ...
                    do // onlycpdrule loop
                    {
                        ...
                        {
                            if (CompoundCheckTimeLimiter == null) return null;
                            ...
                            {
                                for (;
                                     scpd <= Affix.CompoundPatterns.Count && Affix.CompoundPatterns[scpd - 1]
                                         .Pattern3DoesNotMatch (word, i);
                                     scpd++) ;
                                ...
                                st.WriteChars (word.AsSpan (soldi + scpdPatternEntry.Pattern3.Length),
                                    i + scpdPatternEntry.Pattern2.Length);

                                oldlen = len;
                                len += scpdPatternEntry.Pattern.Length + scpdPatternEntry.Pattern2.Length +
                                       scpdPatternEntry.Pattern3.Length;
                                oldcmin = cmin;
                                oldcmax = cmax;
                            ...
                            if (rv == null)
                            {
                                ...
                                if (Affix.CompoundFlag.HasValue)
                                {
                                    ...
                                    if (rv == null)
                                    {
                                        rv = SuffixCheck (stAffix, 0, default, new FlagValue(), Affix.CompoundFlag,
                                            movCompoundOptions);
                                        ...
                                        if (
                                                ...
                                                Suffix != null
                                                &&
                                                Suffix.Entry.ContainsAnyContClass (Affix.CompoundForbidFlag,
                                                    Affix.CompoundEnd)
                                            )
                                            rv = null;
                                    }
                                ...
                                {
                                    var stAffix = st.ToString();
                                    rv = SuffixCheck (stAffix, 0, default, default, Affix.CompoundBegin,
                                        movCompoundOptions);
                                ...
                                {
                                    var stAffix = st.ToString();
                                    rv = SuffixCheck (stAffix, 0, default, default, Affix.CompoundMiddle,
                                        movCompoundOptions);
                                    if (rv == null)
                                    {
                                        if (Affix.CompoundMoreSuffixes)
                            ...
                            else
                            {
                                ...
                                if (ContainFlagsOrBlockSuggest (rv.Detail, isSug, Affix.ForbiddenWord, Affix.NeedAffix,
                                        SpecialFlags.OnlyUpcaseFlag))
                                {
                                    // else check forbiddenwords and needaffix
                                    if (i < st.BufferLength) st[i] = ch;
                            ...
                            if (rv != null)
                            {
                                ...
                                if (ContainFlagsOrBlockSuggest (rv.Detail, isSug, Affix.ForbiddenWord,
                                        SpecialFlags.OnlyUpcaseFlag))
                                {
                                    st.Destroy();
                                    return null;
                                ...
                                if (rv.ContainsFlag (Affix.CompoundRoot)) wordNum++;
                                ...
                                firstWordCompoundAcceptable =
                                    (
                                        ...
                                        rv.Detail.ContainsAnyFlags (SpecialFlags.LetterF, SpecialFlags.LetterG,
                                            SpecialFlags.LetterH) // END of LANG_hu section
                                    )
                            ...
                            else if (huMovRule && Affix.IsHungarian)
                            {
                                ...
                                firstWordCompoundAcceptable =
                                    ...
                                    && Suffix.Entry.ContainsAnyContClass (SpecialFlags.LetterXLower,
                                        SpecialFlags.LetterPercent);
                            }
                            else
                            {
                            ...
                            if (firstWordCompoundAcceptable)
                            {
                                ...
                                if (Affix.IsHungarian)
                                {
                                    ...
                                    if (SuffixExtra) numSyllable -= 1;

                                    // + 1 word, if syllable number of the prefix > 1 (hungarian convention)
                                    if (Prefix != null && GetSyllable (Prefix.Key.AsSpan()) > 1) wordNum++;
                                }
                                ...
                                do
                                {
                                    ...
                                    rv = HomonymWordSearch (st.GetTerminatedSpan().Slice (i), words,
                                        scpdPatternEntryCondition2, scpd == 0);

                                    if (rv != null)
                                    {
                                        // check FORCEUCASE
                                        if (!EnumEx.HasFlag (info, SpellCheckResultType.OrigCap) &&
                                    ...
                                    if (rv != null)
                                    {
                                        ...
                                        if (
                                                ...
                                                (
                                                    ...
                                                    &&
                                                    numSyllable + GetSyllable (rv.Word.AsSpan()) <=
                                            ...
                                            )
                                        {
                                            ...
                                            return Affix.CheckCompoundRep && CompoundReplacementCheck (wordLenPrefix) ||
                                                   CompoundWordPairCheck (wordLenPrefix)
                                                ? null
                                                : rvFirst;
                                        }
                                    }
...

                                    {
                                        ...
                                        if (rv == null && Affix.CompoundRules.HasItems && words != null)
                                        {
                                            ...
                                            if (rv != null && DefCompoundCheck (words.CreateIncremented(), rv.Detail,
                                                    true))
                                            {
                                                st.Destroy();
                                                return rvFirst;
                                    ...
                                    if (
                                            rv != null
                                            &&
                                            ContainFlagsOrBlockSuggest (rv.Detail, isSug, Affix.ForbiddenWord,
                                                SpecialFlags.OnlyUpcaseFlag)
                                        )
                                    {
                                        st.Destroy();
                                    ...
                                    {
                                        rv = CompoundCheck (st.GetTerminatedSpan().Slice (i).ToString(), wordNum + 1,
                                            numSyllable, maxwordnum, words?.CreateIncremented(),
                                            rwords.CreateIncremented(), false, isSug, ref info);
                                    ...
                                    if (rv != null)
                                    {
                                        ...
                                        if (CompoundWordPairCheck (wordLenPrefix)) return null;
                                        ...
                                        if (Affix.CheckCompoundRep || Affix.ForbiddenWord.HasValue)
                                        {
                                            ...
                                            if (word.AsSpan (i).StartsWith (rv.Word.AsSpan()))
                                            {
                                                ...
                                                if (i + rv.Word.Length < st.BufferLength) st[i + rv.Word.Length] = '\0';

                                                var stString = st.GetTerminatedSpan();
                                                if (Affix.CheckCompoundRep && CompoundReplacementCheck (stString) ||
                                                ...
                                                if (Affix.ForbiddenWord.HasValue)
                                                {
                                                    ...
                                                    if (rv2 == null)
                                                        rv2 = AffixCheck (word.AsSpan (0, len), default,
                                                            CompoundOptions.Not);

                                                    if (
                                                            rv2 != null
                                                            && rv2.ContainsFlag (Affix.ForbiddenWord)
                                                            && rv2.Word.AsSpan().EqualsLimited (st.GetTerminatedSpan(),
                                                                i + rv.Word.Length)
                                                        )
                                                    {
                                                        st.Destroy();
                                                ...
                                                if (i + rv.Word.Length < st.BufferLength) st[i + rv.Word.Length] = r;
                                            }
                                        }
                            ...
                            scpd++;
                        } while (!onlycpdrule && Affix.SimplifiedCompound &&
                                 scpd <= Affix.CompoundPatterns.Count); // end of simplifiedcpd loop
                    ...
                    } while (Affix.CompoundRules.HasItems && oldwordnum == 0 &&
                             IntEx.InversePostfixIncrement (ref onlycpdrule));
                }
            ...
            {
                return AffixCheck (word.ToString(), needFlag, inCompound);
            }
            ...
            /// </summary>
            private WordEntry CheckTwoSfx (Affix<PrefixEntry> pe, string word, CompoundOptions inCompound,
                FlagValue needFlag)
            {
                    ...
                    )
                {
                    ...
                    if (TestCondition (peEntry, tmpword))
                        ...
                        if (EnumEx.HasFlag (pe.Options, AffixEntryOptions.CrossProduct) &&
            ...
            protected WordEntry SuffixCheck (string word, AffixEntryOptions sfxOpts, Affix<PrefixEntry> pfx,
                FlagValue cclass, FlagValue needFlag, CompoundOptions inCompound)
            {
                WordEntry rv;

                if (!Affix.Suffixes.HasAffixes) return null;
            ...
            /// </summary>
            protected WordEntry SuffixCheckTwoSfx (string word, AffixEntryOptions sfxopts, Affix<PrefixEntry> pfx,
                FlagValue needflag)
            {
#if DEBUG
                if (word == null) throw new ArgumentNullException (nameof (word));
                ...
                // now handle the general case
                if (word.Length == 0) return null; // FULLSTRIP
                ...
                foreach (var sptr in Affix.Suffixes.GetMatchingAffixes (word, Affix.ContClasses))
                {
                    ...
                    if (rv != null)
                    {
                        ...
                        if (!entry.ContClass.HasItems) SetSuffixAppend (entry.Key);
            ...
            private bool DefCompoundCheck (IncrementalWordList words, WordEntryDetail rv, bool all)
            {
                ...
                {
                    words.SetCurrent (rv);
                    if (Affix.CompoundRules.CompoundCheck (words, all)) return true;
                }
            ...
            private static bool CompoundCaseCheck (string word, int pos)
            {
                ...
                if (pos > 0)
                {
                    ...
                    if (char.IsUpper (word[a])) hasUpper = true;
                }
                ...
                if (pos < word.Length)
                {
                    ...
                    if (!hasUpper && char.IsUpper (word[pos])) hasUpper = true;
                }
            ...
            {
                if (wordSlice.Length < 2 || WordList.AllReplacements.IsEmpty) return false;
                ...
                foreach (var replacementEntry in WordList.AllReplacements)
                    ...
                    if (!string.IsNullOrEmpty (replacementEntry.Med))
                    {
                        ...
                        if (rIndex >= 0)
                        {
                            ...
                            do
                            {
                                if (CandidateCheck (word.Replace (rIndex, lenp, replacement))) return true;
            ...
            {
                if (wordSlice.Length <= 2) return false;
                ...
                for (var i = 1; i < wordSlice.Length; i++)
                {
                    ...
                    if (CandidateCheck (new string (candidate))) return true;
            ...
            private WordEntry CheckWordPrefix (Affix<PrefixEntry> affix, string word, CompoundOptions inCompound,
                FlagValue needFlag)
            {
                // on entry prefix is 0 length or already matches the beginning of the word.
                // So if the remaining root word has positive length
                    ...
                    if (TestCondition (entry, tmpword))
                    {
                        foreach (var detail in LookupDetails (tmpword))
                            if (
                                    ...
                                    &&
                                    !entry.ContainsContClass (Affix
                                        .NeedAffix) // forbid single prefixes with needaffix flag
                                    &&
                                    (
                                        needFlag.IsZero
                                        ||
                        ...
                        {
                            var he = SuffixCheck (tmpword, AffixEntryOptions.CrossProduct, affix, default, needFlag,
                                inCompound);
                            if (he != null) return he;
                        }
                    }
            ...
            private WordEntry CheckWordSuffix (Affix<SuffixEntry> affix, string word, AffixEntryOptions optFlags,
                Affix<PrefixEntry> pfx, FlagValue cclass, FlagValue needFlag, FlagValue badFlag)
            {
            ...
            /// </summary>
            private WordEntry CheckTwoSfx (Affix<SuffixEntry> se, string word, AffixEntryOptions optflags,
                Affix<PrefixEntry> ppfx, FlagValue needflag)
            {
                // if this suffix is being cross checked with a prefix
                // but it does not support cross products skip it

                if (EnumEx.HasFlag (optflags, AffixEntryOptions.CrossProduct) &&
                    !EnumEx.HasFlag (se.Options, AffixEntryOptions.CrossProduct)) return null;
                    ...
                    )
                {
                    ...
                    if (TestCondition (entry, tmpword))
                    {
                        var he = ppfx != null && entry.ContainsContClass (ppfx.AFlag)
                            ...
                            ? SuffixCheck (tmpword, AffixEntryOptions.None, default, se.AFlag, needflag,
                                CompoundOptions.Not)
            ...
            {
                return WordList.ContainsEntriesForRootWord (word) ||
                       AffixCheck (word, default, CompoundOptions.Not) != null;
            }
