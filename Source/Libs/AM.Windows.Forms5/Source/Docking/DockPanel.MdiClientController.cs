            ...
            public BorderStyle BorderStyle
            {
                set
                {
                    ...
                    if (!Win32Helper.IsRunningOnMono)
                    {
                        ...
                        int style = Win32.NativeMethods.GetWindowLong(MdiClient.Handle, (int)Win32.GetWindowLongIndex.GWL_STYLE);
                        int exStyle = Win32.NativeMethods.GetWindowLong(MdiClient.Handle, (int)Win32.GetWindowLongIndex.GWL_EXSTYLE);
                        ...
                        Win32.NativeMethods.SetWindowLong(MdiClient.Handle, (int)Win32.GetWindowLongIndex.GWL_STYLE, style);
                        Win32.NativeMethods.SetWindowLong(MdiClient.Handle, (int)Win32.GetWindowLongIndex.GWL_EXSTYLE, exStyle);
                    }
                ...
                switch (m.Msg)
                {
                    case (int)Win32.Msgs.WM_NCCALCSIZE:
                        ...
                        if (!AutoScroll)
                        {
                            if (!Win32Helper.IsRunningOnMono)
                            {
                                Win32.NativeMethods.ShowScrollBar(m.HWnd, (int) Win32.ScrollBars.SB_BOTH, 0 /*false*/);
                            }
                        }
