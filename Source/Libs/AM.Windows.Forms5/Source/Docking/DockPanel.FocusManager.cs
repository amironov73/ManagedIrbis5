    ...
    partial class DockPanel
    {
        ...
        private class FocusManagerImpl : Component, IContentFocusManager, IFocusManager
        {
            ...
            private class LocalWindowsHook : IDisposable
            {
                ...
                {
                    if (code < 0)
                        return AM.Windows.Forms.Docking.Win32.NativeMethods.CallNextHookEx(m_hHook, code, wParam, lParam);
            ...
            {
                DockPane value = Win32Helper.IsRunningOnMono ? null : GetPaneFromHandle(Win32.NativeMethods.GetFocus());
