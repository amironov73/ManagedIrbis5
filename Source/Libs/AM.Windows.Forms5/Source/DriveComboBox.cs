...
/// <summary>
/// <see cref="ComboBox"/> that contains list of installed drives.
/// </summary>
    ...
    : ComboBox
{
    ...
    ///<inheritdoc cref="ComboBox.OnDrawItem"/>
        ...
        )
    {
        ...
        if ((eventArgs.Index < 0)
            || (eventArgs.Index >= Items.Count))
        {
            return;
        }

        var graphics = eventArgs.Graphics;
        var drive = (DriveInfo)Items[eventArgs.Index];
        ...
        using (Brush brush = new SolidBrush (eventArgs.ForeColor))
        {
            graphics.DrawString (text, eventArgs.Font!, brush, rect);
        }
    ...
    /// <inheritdoc cref="ComboBox.Dispose(bool)"/>
