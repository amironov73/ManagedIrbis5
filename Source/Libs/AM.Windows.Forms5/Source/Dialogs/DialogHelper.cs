...
static class DialogHelper
{
        ...
        Font mainInstructionFallbackFont, Font contentFallbackFont, int width)
    {
        ...
        DrawText (dc, mainInstruction, content, ref location, mainInstructionFallbackFont, contentFallbackFont,
            true, width);
        return location.Y;
    }
        ...
        int minimumWidth, int textMinimumHeight)
    {
        ...
        int height = GetTextHeight (dc, mainInstruction, content, mainInstructionFallbackFont, contentFallbackFont,
            width);
        ...
        ref Point location, bool measureOnly, int width)
    {
        ...
        // that does work.
        Rectangle textRect = new Rectangle (location.X, location.Y, width,
            NativeMethods.IsWindowsXPOrLater ? Int32.MaxValue : 100000);
