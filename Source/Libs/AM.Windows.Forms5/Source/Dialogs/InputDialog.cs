...
public partial class InputDialog : Component, IBindableComponent
{
    ...
    /// </value>
    [Localizable (true), Category ("Appearance"), Description ("The window title of the task dialog."),
     DefaultValue ("")]
    ...
    /// </remarks>
    [Localizable (true), Category ("Appearance"), Description ("The text specified by the user."),
     DefaultValue ("")]
    public string Input
    {
    ...
    /// </value>
    [Localizable (true), Category ("Behavior"),
    ...
    /// </value>
    [Category ("Behavior"), Description ("Indicates whether the input field will have multiline support."),
     DefaultValue (false)]
    ...
    /// </value>
    [SuppressMessage ("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly"), Browsable (false),
