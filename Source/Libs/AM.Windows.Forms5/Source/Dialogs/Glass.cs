...
public static class Glass
{
    ...
    {
        get { return OSSupportsDwmComposition && NativeMethods.DwmIsCompositionEnabled(); }
    }
        ...
        Padding padding, Color foreColor, int glowSize, TextFormatFlags textFormat)
    {
        ...
        try
        {
            ...
            using (SafeGdiHandle dib = NativeMethods.CreateDib (bounds, primaryHdc, memoryHdc))
            {
                ...
                NativeMethods.RECT textBounds = new NativeMethods.RECT (padding.Left, padding.Top,
                ...
                NativeMethods.BitBlt (primaryHdc, bounds.Left, bounds.Top, bounds.Width, bounds.Height, memoryHdc,
                    0, 0, SRCCOPY);
            }
        }
        finally
