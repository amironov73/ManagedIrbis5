    ...
    protected override void WndProc (ref Message m)
    {
        ...
        switch (m.Msg)
        {
            case NativeMethods.WM_NCHITTEST:
                if (_allowGlassDragging && m.Result == new IntPtr ((int)NativeMethods.HitTestResult.Client) &&
    ...
    private void PaintGlassArea (PaintEventArgs pevent, Brush brush)
    {
        ...
        else
        {
            Rectangle rect = new Rectangle (_glassMargin.Left, _glassMargin.Top,
                ClientSize.Width - _glassMargin.Right, ClientSize.Height - _glassMargin.Bottom);
