...
public sealed class VistaFolderBrowserDialog : CommonDialog
{
    ...
    [Localizable (false),
     ...
     Category ("Folder Browsing"), Browsable (true), DefaultValue (typeof (Environment.SpecialFolder), "Desktop")]
    ...
    [Browsable (true),
     Editor (
         ...
         typeof (UITypeEditor)), Description ("The path selected by the user."), DefaultValue (""),
