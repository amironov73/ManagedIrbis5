...
public abstract class VistaFileDialog : CommonDialog
{
    ...
    [Description ("The file names of all selected files in the dialog box."), Browsable (false),
    ...
    /// </value>
    [Description ("The index of the filter currently selected in the file dialog box."), Category ("Behavior"),
     DefaultValue (1)]
