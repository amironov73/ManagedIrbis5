...
public partial class CredentialDialog : Component
{
    ...
    /// </para>
    /// </remarks>
    [Category ("Behavior"), Description ("Indicates whether to use the application instance credential cache."),
     DefaultValue (false)]
    ...
    /// </remarks>
    [Category ("Appearance"), Description ("Indicates whether the \"Save password\" checkbox is checked."),
     DefaultValue (false)]
    ...
    /// </para>
    /// </remarks>
    [Localizable (true), Category ("Appearance"), Description ("The title of the credentials dialog."),
     DefaultValue ("")]
    ...
    /// </para>
    /// </remarks>
    [Localizable (true), Category ("Appearance"), Description ("Additional text to display in the dialog."),
    ...
    /// </summary>
    /// <value>
    /// One of the values of the <see cref="Ookii.Dialogs.WinForms.DownlevelTextMode"/> enumeration. The default value is
    /// <see cref="Ookii.Dialogs.WinForms.DownlevelTextMode.MainInstructionAndContent"/>.
    /// </value>
    /// <remarks>
    /// <para>
    ...
    private static string DecryptPassword (byte[] encrypted, byte[] additionalEntropy)
    {
        try
        {
            return Encoding.UTF8.GetString (ProtectedData.Unprotect (encrypted, additionalEntropy,
                DataProtectionScope.CurrentUser));
        }
