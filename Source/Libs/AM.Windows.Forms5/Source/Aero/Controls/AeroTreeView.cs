    ...
    : TreeView
{
    ...
    protected override void OnHandleCreated (EventArgs e)
    {
        ...
        if (PlatformHelper.VistaOrHigher)
        {
            ...
            var lParam = NativeMethods.SendMessage (Handle, TVM_GETEXTENDEDSTYLE, IntPtr.Zero, IntPtr.Zero);
            lParam = new IntPtr (lParam.ToInt32() |
                                 (TVS_EX_AUTOHSCROLL | TVS_EX_FADEINOUTEXPANDOS | TVS_EX_DOUBLEBUFFER));
            NativeMethods.SendMessage (Handle, TVM_SETEXTENDEDSTYLE, IntPtr.Zero, lParam);
        }
    }
