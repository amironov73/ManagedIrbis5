...
public static class GenericExtensions
{
    ...
    public static TOut Modify<TIn, TOut>
        (
            this TIn target,
            Func<TIn, TOut> func
        )
    ...
    /// <summary>
    /// Modifies the specified object by passing it to the specified method
    /// if a specified condition is fulfilled and then returns the result.
    /// </summary>
    /// <typeparam name="T">The type of the specified object.</typeparam>
    /// <param name="target">The target.</param>
    /// <param name="condition">The condition.</param>
    /// <param name="func">The function.</param>
    /// <returns>The object returned by the specified method or the original
    /// object depending on whether the condition was fulfilled.</returns>
    public static T ModifyIf<T>
        (
            this T target,
            Func<bool> condition,
            Func<T, T> func
