...
/* RazorApplication.cs -- класс-приложение
    ...
    : IMagnaApplication
{
    ...
    protected virtual bool FinalInitialization()
    {
        ...
        _builder.Services.AddLocalization();
        ...
        )
    {
        ...
        _builder.Host.ConfigureAppConfiguration (configureDelegate);
    }
        ...
        where TContainerBuilder: IContainer
    {
        ...
        _builder.Host.ConfigureContainer (configureDelegate);
    }
        ...
        )
    {
        ...
        _builder.Host.ConfigureHostConfiguration (configureDelegate);
    }
        ...
        )
    {
        ...
        _builder.Host.ConfigureLogging (configureDelegate);
    }
        ...
        )
    {
        ...
        _builder.Host.ConfigureServices (configureDelegate);
    }
        ...
        )
    {
        ...
        _builder.Services.Configure (configureDelegate);
    }
        ...
        where TContainerBuilder: IContainer
    {
        ...
        _builder.Host.UseServiceProviderFactory (providerFactory);
    }
