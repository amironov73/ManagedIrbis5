...
public static class HtmlHelperExtensions
{
    ...
    public static HtmlTag ValidationMessage<T, TResult> (this IHtmlHelper<T> helper,
    ...
    public static HtmlTag Tag<T, TResult> (this IHtmlHelper<T> helper, Expression<Func<T, TResult>> expression,
        string category)
        where T : class
    {
        var generator = GetGenerator (helper, expression);
    ...
    public static IElementGenerator<T> GetGenerator<T, TResult> (IHtmlHelper<T> helper,
    ...
    public static IElementGenerator<T> GetGenerator<T> (IHtmlHelper<T> helper, params object[] additionalServices)
        where T : class
    {
        ...
        object ServiceLocator (Type t) => additionalServices.FirstOrDefault (t.IsInstanceOfType) ??
                                          helper.ViewContext.HttpContext.RequestServices.GetService (t);
