...
public static class SupplyUtility
{
        ...
        )
    {
        ...
        catch (Exception exception)
        {
            Magna.Logger.LogError
                (
                    exception,
                    nameof (SupplyUtility) + "::" + nameof (GetMsSqlConnection)
                );
            throw;
        }
    }
    ...
    {
        return connection.GetTable<BookBinding>();
    }
    ...
    {
        return connection.GetTable<Contingent>();
    }
    ...
    {
        return connection.GetTable<Department>();
    }
    ...
    {
        return connection.GetTable<Discipline>();
    }
    ...
    {
        return connection.GetTable<GroupBinding>();
    }
    ...
    /// </summary>
    public static int CountContingentByCathedra
        (
        ...
        )
    {
        ...
        return connection.GetContingent()
            .Where (contingent => contingent.Cathedra == cathedra)
            .Sum (contingent => contingent.Students);
    }
    ...
    /// </summary>
    public static int CountContingentByShortcut
        (
            this DataConnection connection,
            string shortcut
        )
    {
        Sure.NotNull (connection);
        Sure.NotNullNorEmpty (shortcut);

        return connection.GetContingent()
            .Where (contingent => contingent.Shortcut == shortcut)
            .Sum (contingent => contingent.Students);
    }
    ...
    /// </summary>
    public static int CountContingentByCode
        (
            this DataConnection connection,
            string name
        )
    {
        ...
        return connection.GetContingent()
            .Where (contingent => contingent.Name == name)
            .Sum (contingent => contingent.Students);
    }
