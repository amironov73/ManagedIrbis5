namespace AM.Windows.DevEx
{
    partial class PdfForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.pdfViewer1.Location = new System.Drawing.Point(0, 45);
            this.pdfViewer1.MenuManager = this.barManager1;
            this.pdfViewer1.Name = "pdfViewer1";
            this.pdfViewer1.Size = new System.Drawing.Size(632, 213);
            ...
            this.repositoryItemPageNumberEdit1.LabelFormat = "из {0}";
            ...
            toolTipTitleItem3.Text = "Уменьшить масштаб (Ctrl + Minus)";
            toolTipItem3.Text = "Уменьшить для того, чтобы увидеть больший фрагмент документа меньшего размера.";
            ...
            toolTipTitleItem4.Text = "Увеличить масштаб (Ctrl + Plus)";
            toolTipItem4.Text = "Увеличить масштаб для получения детализованного представления документа PDF.";
