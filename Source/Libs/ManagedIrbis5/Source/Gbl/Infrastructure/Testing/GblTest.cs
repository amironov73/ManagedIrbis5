...
namespace ManagedIrbis.Gbl.Infrastructure.Testing
{
    ...
    public sealed class GblTest
    {
        ...
        private string GetFullName (string shortName) => Path.Combine
            (
                Folder.ThrowIfNull (nameof (Folder)),
                shortName
            );
        ...
        {
            Sure.NotNullNorEmpty (directory, nameof (directory));
        ...
        } // method IsDirectoryContainsTest
