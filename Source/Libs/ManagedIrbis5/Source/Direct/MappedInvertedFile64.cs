...
/* MappedInvertedFile64.cs -- доступ к инверсному файлу с помощью проецирования в память
...
/// <summary>
/// Доступ к инверсному файлу с помощью проецирования его в память.
/// </summary>
        ...
        lock (_lockObject)
        {
            ...
            catch (Exception exception)
            {
                Magna.Logger.LogError
                    (
                        exception,
                        nameof (MappedInvertedFile64) + "::" + nameof (SearchExact)
                    );
            }
        }
