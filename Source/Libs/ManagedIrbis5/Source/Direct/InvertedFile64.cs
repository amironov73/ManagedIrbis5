...
/* InvertedFile64.cs -- инвертированный (индексный) файл ИРБИС64
...
/// <summary>
/// Инвертированный (индексный) файл ИРБИС64.
/// </summary>
    ...
    IServiceProvider
{
    ...
    /// <summary>
    /// Простой поиск на точное совпадение с термином.
    /// </summary>
    ...
    /// <summary>
    /// Поиск с учетом усечения термина.
    /// </summary>
    ...
    /// <summary>
    /// Простой поиск на совпадение с термином или с учетом усечения.
    /// </summary>
