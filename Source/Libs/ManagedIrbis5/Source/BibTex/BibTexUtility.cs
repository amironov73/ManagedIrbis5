...
/* BibTex.cs -- методы для работы с BibTex
...
/// <summary>
/// Методы для работы с BibTex.
/// </summary>
public static class BibTexUtility
{
    ...
    /// </summary>
    public static BibTexFile ReadFile
        (
            string fileName,
        ...
        )
    {
        ...
        return ReadStream (new StreamReader (fileName, encoding));
    }

    /// <summary>
    /// Загрузка данных из текстового потока.
    /// </summary>
    public static BibTexFile ReadStream
        (
            StreamReader reader
        )
    {
        ...
        var text = reader.ReadToEnd().ThrowIfNullOrEmpty();

        return ReadText (text);
    }

    /// <summary>
    /// Загрузка данных из текстовой строки.
    /// </summary>
    public static BibTexFile ReadText
        (
            string text
        )
    {
