        ...
        IVerifiable
    {
            ...
            )
        {
            ExternalResource result = new ExternalResource
            {
                ...
                Description = field.GetFirstSubFieldValue('t').ToString(),
                FileCount = Map.ToInt32(field, 'n'),
                NameTemplate = field.GetFirstSubFieldValue('m').ToString(),
                FileType = field.GetFirstSubFieldValue('h').ToString(),
                Textbook = field.GetFirstSubFieldValue('k').ToString(),
                AccessLevel = field.GetFirstSubFieldValue('d').ToString(),
                LanOnly = Map.ToBoolean(field, 'l'),
                InputDate = Map.ToDateTime(field, '1'),
                FileSize = Map.ToInt64(field, '2'),
                Number = field.GetFirstSubFieldValue('3').ToString(),
                LastCheck = Map.ToDateTime(field, '5'),
                ImageSize = field.GetFirstSubFieldValue('6').ToString(),
                Issn = field.GetFirstSubFieldValue('x').ToString(),
                Form = field.GetFirstSubFieldValue('b').ToString(),
                Provider = field.GetFirstSubFieldValue('f').ToString(),
                Price = field.GetFirstSubFieldValue('e').ToString(),
                Index = field.GetFirstSubFieldValue('w').ToString(),
                Remarks = field.GetFirstSubFieldValue('p').ToString(),
                System = field.GetFirstSubFieldValue('s').ToString(),
                Field = field
            };
