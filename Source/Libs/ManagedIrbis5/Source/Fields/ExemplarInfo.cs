        ...
        : IHandmadeSerializable
    {
            ...
            )
        {
            ...
            var result = new ExemplarInfo
                {
                    Status         = field.GetFirstSubFieldValue('a').ToString(),
                    Number         = field.GetFirstSubFieldValue('b').ToString(),
                    Date           = field.GetFirstSubFieldValue('c').ToString(),
                    Place          = field.GetFirstSubFieldValue('d').ToString(),
                    Collection     = field.GetFirstSubFieldValue('q').ToString(),
                    ShelfIndex     = field.GetFirstSubFieldValue('r').ToString(),
                    Price          = field.GetFirstSubFieldValue('e').ToString(),
                    Barcode        = field.GetFirstSubFieldValue('h').ToString(),
                    Amount         = field.GetFirstSubFieldValue('1').ToString(),
                    Purpose        = field.GetFirstSubFieldValue('t').ToString(),
                    Coefficient    = field.GetFirstSubFieldValue('=').ToString(),
                    OffBalance     = field.GetFirstSubFieldValue('4').ToString(),
                    KsuNumber1     = field.GetFirstSubFieldValue('u').ToString(),
                    ActNumber1     = field.GetFirstSubFieldValue('y').ToString(),
                    Channel        = field.GetFirstSubFieldValue('f').ToString(),
                    OnHand         = field.GetFirstSubFieldValue('2').ToString(),
                    ActNumber2     = field.GetFirstSubFieldValue('v').ToString(),
                    WriteOff       = field.GetFirstSubFieldValue('x').ToString(),
                    Completion     = field.GetFirstSubFieldValue('k').ToString(),
                    ActNumber3     = field.GetFirstSubFieldValue('w').ToString(),
                    Moving         = field.GetFirstSubFieldValue('z').ToString(),
                    NewPlace       = field.GetFirstSubFieldValue('m').ToString(),
                    CheckedDate    = field.GetFirstSubFieldValue('s').ToString(),
                    CheckedAmount  = field.GetFirstSubFieldValue('0').ToString(),
                    RealPlace      = field.GetFirstSubFieldValue('!').ToString(),
                    BindingIndex   = field.GetFirstSubFieldValue('p').ToString(),
                    BindingNumber  = field.GetFirstSubFieldValue('i').ToString(),
