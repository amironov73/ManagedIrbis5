...
namespace ManagedIrbis.Systematization
{
    ...
    /// </summary>
    [XmlRoot("bbk")]
    [DebuggerDisplay("{" + nameof(MainIndex) + "}")]
    public sealed class BbkIndex
    {
        ...
        public NonNullCollection<string> SpecialIndex { get; set; } = new();
        ...
        /// Определители.
        /// </summary>
        public NonNullCollection<string> Qualifiers { get; private set; } = new();
