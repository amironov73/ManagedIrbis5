    ...
    IVerifiable
{
    ...
    /// <summary>
    /// Числовая или буквенная метка поля.
    /// </summary>
    [XmlElement ("tag")]
    [JsonPropertyName ("tag")]
    [DisplayName ("Метка")]
    [Description ("Числовая или буквенная метка поля")]
    ...
    [Description ("Повторяемость поля/подполя")]
    ...
    [DisplayName ("Индекс помощи")]
    [Description ("Индекс контекстной помощи")]
    ...
    [Description ("Дополнительная информация для расширенных средств ввода")]
    [JsonIgnore (Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [Description ("Текст помощи (инструкции), сопровождающей ввод в поле")]
    [JsonIgnore (Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [Description ("Значение по умолчанию при создании новой записи")]
    [JsonIgnore (Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    [Description ("Используется при определенных режимах ввода")]
    [JsonIgnore (Condition = JsonIgnoreCondition.WhenWritingNull)]
    ...
    {
        return $"{Tag.ToVisibleString()}: {Title.ToVisibleString()} [{Repeatable}][{EditMode.ToVisibleString()}]";
    }
