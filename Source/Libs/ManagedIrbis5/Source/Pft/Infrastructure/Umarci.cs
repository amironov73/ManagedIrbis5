...
/* Umarci.cs -- форматный выход UMARCI
    ...
    : IFormatExit
{
    ...
    /// <summary>
    /// Бросать исключения при пустом содержимом UMARCI?
    /// По умолчанию - нет.
    /// </summary>
