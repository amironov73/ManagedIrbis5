...
/* StandardFunctions.cs -- стандартные встроенные функции PFT
...
/// <summary>
/// Стандартные встроенные функции PFT.
/// </summary>
internal static partial class StandardFunctions
{
        ...
        )
    {
        ...
        Magna.Logger.LogError
            (
                nameof (StandardFunctions) + "::" + nameof (Fatal)
                + ": message={Message}",
    ...
    private static void HtmlEscape
        (
            PftContext context,
            PftNode node,
            PftNode[] arguments
    ...
    private static void MachineName
        (
            PftContext context,
            PftNode node,
            PftNode[] arguments
