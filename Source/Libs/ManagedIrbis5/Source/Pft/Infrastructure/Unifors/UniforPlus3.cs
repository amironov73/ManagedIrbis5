...
/// Работа со строками.
/// </summary>
internal static class UniforPlus3
{
        ...
        try
        {
            ...
            catch (Exception exception)
            {
                Magna.Logger.LogError
                    (
                        exception,
                        nameof (UniforPlus3) + "::" + nameof (SearchFormat)
                    );
        ...
        )
    {
        ...
        catch (Exception exception)
        {
            Magna.Logger.LogError
                (
                    exception,
                    nameof (UniforPlus3) + "::" + nameof (GetExternalDbTermRecordCount)
                );
        }
        ...
        )
    {
        ...
        catch (Exception exception)
        {
            Magna.Logger.LogError
                (
                    exception,
                    nameof (UniforPlus3) + "::" + nameof (Divide)
                );
        }
    }
}
