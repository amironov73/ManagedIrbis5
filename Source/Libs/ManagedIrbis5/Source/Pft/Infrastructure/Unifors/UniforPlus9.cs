...
/// </summary>
internal static class UniforPlus9
{
        ...
        if (!string.IsNullOrEmpty (expression))
        {
            ...
            catch (Exception exception)
            {
                Magna.Logger.LogError
                    (
                        exception,
                        nameof (Unifor9) + "::" + nameof (GetFileSize)
                    );
            }
    ...
    {
        new() { Suffix = "b", Value = 1E0 },
        new() { Suffix = "Kb", Value = 1E3 },
        new() { Suffix = "Mb", Value = 1E6 },
        new() { Suffix = "Gb", Value = 1E9 },
        new() { Suffix = "Tb", Value = 1E12 },
        new() { Suffix = "Pb", Value = 1E15 },
        new() { Suffix = "Eb", Value = 1E18 },
        new() { Suffix = "Zb", Value = 1E21 },
        new() { Suffix = "Yb", Value = 1E24 },
    };
    ...
    {
        Sure.NotNullNorEmpty (romanNumber);
