...
namespace FluentAvalonia.UI.Controls
{
    ...
    public partial class TabViewItem : ListBoxItem
    {
        ...
        private void UpdateTabGeometry()
        {
            ...
            var popupRadius = this.TryFindResource (c_overlayCornerRadiusKey, out var value)
                ? (CornerRadius)value
                : default;
        ...
        private void UpdateForeground()
        {
            ...
            bool isForegroundSet =
                this.GetDiagnostic (ForegroundProperty).Priority != Avalonia.Data.BindingPriority.Unset;
