...
public class DropDownButton : TemplatedControl
{
    ...
    public static readonly StyledProperty<object> SelectedItemProperty =
        AvaloniaProperty.Register<DropDownButton, object> (nameof (SelectedItem),
    ...
    public static readonly StyledProperty<DropDownButtonContentDisplayMode> DisplayModeProperty =
        AvaloniaProperty.Register<DropDownButton, DropDownButtonContentDisplayMode> (nameof (DisplayMode),
            defaultValue: DropDownButtonContentDisplayMode.Button);
        ...
        )
    {
        ...
        _popupMenu = eventArgs.NameScope.Find<Popup> (PART_PopupMenu);
        _popupButton = eventArgs.NameScope.Find<ToggleButton> (PART_PopUpButton);
        _listBox = eventArgs.NameScope.Find<ListBox> (PART_ListBox);
        ...
        _listBox.SelectionChanged += (o, e) => { _popupMenu.Close(); };
    }
}
