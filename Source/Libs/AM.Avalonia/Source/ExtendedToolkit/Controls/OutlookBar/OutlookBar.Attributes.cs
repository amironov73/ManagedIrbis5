...
public partial class OutlookBar
{
    ...
    private Size _finalSize = new (0, 0);
    ...
    {
        get => GetValue (SideButtonsProperty);
    ...
    {
        get => GetValue (MaximizedSectionsProperty);
    ...
    {
        get => GetValue (MinimizedSectionsProperty);
    ...
    {
        get => GetValue (OverflowMenuItemsProperty);
    ...
    {
        get => GetValue (OptionButtonsProperty);
    ...
    {
        get => GetValue (ShowSideButtonsProperty);
    ...
    {
        get => GetValue (MinimizedWidthProperty);
    ...
    {
        get => GetValue (MaximizedWidthProperty);
    ...
    public static readonly StyledProperty<HorizontalAlignment> DockPositionProperty =
        AvaloniaProperty.Register<OutlookBar, HorizontalAlignment> (nameof (DockPosition),
    ...
    {
        get => GetValue (MaxNumberOfButtonsProperty);
    ...
    {
        get => GetValue (SelectedSectionIndexProperty);
    ...
    {
        get => GetValue (CollapsedSectionContentProperty);
    ...
    {
        get => GetValue (IsOverflowVisibleProperty);
    ...
    /// </summary>
    public ICommand StartDraggingCommand { get; private set; }
    ...
    public static readonly StyledProperty<double> PopupWidthProperty =
        AvaloniaProperty.Register<OutlookBar, double> (nameof (PopupWidth), defaultValue: double.NaN);
    ...
    {
        get => GetValue (IsButtonSplitterVisibleProperty);
    ...
    {
        get => GetValue (NavigationPaneTextProperty);
    ...
    {
        get => GetValue (OdcExpanderClassesProperty);
    ...
    {
        get => GetValue (OptionButtonClassesProperty);
    ...
    {
        get => GetValue (OptionToggleButtonClassesProperty);
    ...
    {
        add => AddHandler (SelectedSectionChangedEvent, value);
        remove => RemoveHandler (SelectedSectionChangedEvent, value);
    }
}
