    ...
    : TemplatedControl
{
    ...
    private bool _isContexMenuOpened;
    ...
    public static readonly RoutedEvent<ColorRoutedEventArgs> SelectedColorChangedEvent =
        RoutedEvent.Register<ColorPicker, ColorRoutedEventArgs> (nameof (SelectedColorChangedEvent),
    ...
    public string HexValue
    {
        ...
        internal set { SetAndRaise (HexValueProperty, ref _hexValue, value); }
    }
        ...
        )
    {
        ...
        button = eventArgs.NameScope.Find<ToggleButton> (PART_Button);
        button.Click += Button_Click;

        colorSelector = eventArgs.NameScope.Find<ColorSelector> (PART_ColorSelector);
        ...
        popupMenu = eventArgs.NameScope.Find<Popup> (PART_PopupMenu);
        popupMenu.Opened += (o, e) => { _isContexMenuOpened = true; };
