...
public class Badged : ContentControl
{
    ...
    {
        badged.IsBadgeSet = !string.IsNullOrWhiteSpace (e.NewValue as string) ||
                            (e.NewValue != null && !(e.NewValue is string));
        ...
        )
    {
        ...
        _badgeContainer = eventArgs.NameScope.Get<Control> (BadgeContainerPartName);
    }
