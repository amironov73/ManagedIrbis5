...
public abstract class GridEntry
    : AvaloniaObject, /*INotifyPropertyChanged,*/ IPropertyFilterTarget, IDisposable
{
    #region Properties
    ...
    /// </summary>
    public bool IsVisible => IsBrowsable && MatchesFilter;
    ...
    {
        FilterApplied?.Invoke (this, new PropertyFilterAppliedEventArgs (filter));
    }
    ...
    {
        BrowsableChanged?.Invoke (this, EventArgs.Empty);
    }
}
