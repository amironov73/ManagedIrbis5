...
public partial class PropertyItem
{
    ...
    public PropertyItemValue ParentValue { get; }
    ...
    public bool IsAdvanced
    {
        get
        {
            ...
            return browsable is { State: EditorBrowsableState.Advanced };
        }
    }
    ...
    /// </value>
    public bool IsLocalizable => _isLocalizable;
    ...
    public static readonly DirectProperty<PropertyItem, bool> IsReadOnlyProperty =
        AvaloniaProperty.RegisterDirect<PropertyItem, bool> (
            nameof (IsReadOnly),
            o => o.IsReadOnly, (o, v) => o.IsReadOnly = v, unsetValue: false,
    ...
    /// </returns>
    public virtual Type? PropertyType => _descriptor?.PropertyType;
    ...
    /// </remarks>
    public object UnwrappedComponent => _unwrappedComponent ?? (_unwrappedComponent = ObjectServices.GetUnwrappedObject (_component));
    ...
    public virtual AttributeCollection? Attributes => _descriptor?.Attributes;

    /// <summary>
    /// Gets the custom attributes container.
    /// </summary>
    /// <value>The custom attributes container.</value>
    public AttributesContainer Metadata => _metadata;

    /// <summary>
    /// Gets the converter.
    /// </summary>
    /// <value>The converter.</value>
    public TypeConverter Converter => ObjectServices.GetPropertyConverter (_descriptor);
    ...
    /// </value>
    public bool CanClearValue => _descriptor.CanResetValue (_component);
    ...
    /// </value>
    public bool IsCollection => typeof (IList).IsAssignableFrom (PropertyType);
