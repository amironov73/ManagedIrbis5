...
public partial class MetroWindow : Window
{
    ...
    {
        get => GetValue (ShowIconOnTitleBarProperty);
    ...
    {
        get => GetValue (ShowDialogsOverTitleBarProperty);
    ...
    {
        get => GetValue (IsAnyDialogOpenProperty);
    ...
    {
        get => GetValue (ShowMaxRestoreButtonProperty);
    ...
    {
        get => GetValue (IsMinButtonEnabledProperty);
    ...
    {
        get => GetValue (IsMaxRestoreButtonEnabledProperty);
    ...
    {
        get => GetValue (TitleCharacterCasingProperty);
    ...
    public static readonly StyledProperty<HorizontalAlignment> TitleAlignmentProperty =
        AvaloniaProperty.Register<MetroWindow, HorizontalAlignment> (nameof (TitleAlignment),
    ...
    {
        get => GetValue (SaveWindowPositionProperty);
    ...
    {
        get => GetValue (WindowTransitionsEnabledProperty);
    ...
    {
        get => GetValue (WindowTitleBrushProperty);
    ...
    public static readonly StyledProperty<IBrush> WindowTitleBrushProperty =
        AvaloniaProperty.Register<MetroWindow, IBrush> (nameof (WindowTitleBrush),
    ...
    {
        get => GetValue (NonActiveWindowTitleBrushProperty);
    ...
    public static readonly StyledProperty<IBrush> NonActiveWindowTitleBrushProperty =
        AvaloniaProperty.Register<MetroWindow, IBrush> (nameof (NonActiveWindowTitleBrush),
    ...
    {
        get => GetValue (NonActiveBorderBrushProperty);
    ...
    public static readonly StyledProperty<IBrush> NonActiveBorderBrushProperty =
        AvaloniaProperty.Register<MetroWindow, IBrush> (nameof (NonActiveBorderBrush), defaultValue: Brushes.Gray);
    ...
    {
        get => GetValue (NonActiveGlowBrushProperty);
    ...
    {
        get => GetValue (OverlayFadeInProperty);
    ...
    {
        get => GetValue (OverlayFadeOutProperty);
    ...
    {
        get => GetValue (IgnoreTaskbarOnMaximizeProperty);
    ...
    public static readonly StyledProperty<Thickness> ResizeBorderThicknessProperty =
        AvaloniaProperty.Register<MetroWindow, Thickness> (nameof (ResizeBorderThickness),
            defaultValue: new Thickness (6D));
    ...
    {
        get => GetValue (KeepBorderOnMaximizeProperty);
    ...
    {
        get => GetValue (TryToBeFlickerFreeProperty);
    ...
    {
        get => GetValue (FlyoutOverlayBrushProperty);
    ...
    public static readonly RoutedEvent<FlyoutStatusChangedRoutedEventArgs> FlyoutsStatusChangedEvent =
        RoutedEvent.Register<MetroWindow, FlyoutStatusChangedRoutedEventArgs> (nameof (FlyoutsStatusChangedEvent),
    ...
    public static readonly RoutedEvent<RoutedEventArgs> WindowTransitionCompletedEvent =
        RoutedEvent.Register<MetroWindow, RoutedEventArgs> (nameof (FlyoutsStatusChangedEvent),
            RoutingStrategies.Bubble);
    ...
    {
        get => GetValue (LeftWindowCommandsProperty);
    ...
    {
        get => GetValue (RightWindowCommandsProperty);
    ...
    {
        get => GetValue (WindowButtonCommandsProperty);
    ...
    {
        get => GetValue (LeftWindowCommandsOverlayBehaviorProperty);
    ...
    public static readonly StyledProperty<WindowCommandsOverlayBehavior> LeftWindowCommandsOverlayBehaviorProperty =
        AvaloniaProperty.Register<MetroWindow, WindowCommandsOverlayBehavior> (
            nameof (LeftWindowCommandsOverlayBehavior), defaultValue: WindowCommandsOverlayBehavior.Never);
    ...
    {
        get => GetValue (RightWindowCommandsOverlayBehaviorProperty);
    ...
    /// </summary>
    public static readonly StyledProperty<WindowCommandsOverlayBehavior>
        RightWindowCommandsOverlayBehaviorProperty =
            AvaloniaProperty.Register<MetroWindow, WindowCommandsOverlayBehavior> (
                nameof (RightWindowCommandsOverlayBehavior), defaultValue: WindowCommandsOverlayBehavior.Never);
    ...
    {
        get => GetValue (WindowButtonCommandsOverlayBehaviorProperty);
    ...
    public static readonly StyledProperty<OverlayBehavior> WindowButtonCommandsOverlayBehaviorProperty =
        AvaloniaProperty.Register<MetroWindow, OverlayBehavior> (nameof (WindowButtonCommandsOverlayBehavior),
    ...
    {
        get => GetValue (IconOverlayBehaviorProperty);
    ...
    public static readonly StyledProperty<OverlayBehavior> IconOverlayBehaviorProperty =
        AvaloniaProperty.Register<MetroWindow, OverlayBehavior> (nameof (IconOverlayBehavior),
            OverlayBehavior.Never);
    ...
    {
        get => GetValue (UseNoneWindowStyleProperty);
    ...
    {
        get => GetValue (OverrideDefaultWindowCommandsBrushProperty);
    ...
    {
        get => GetValue (IsWindowDraggableProperty);
