...
public static class BarsikUtility
{
        ...
        )
    {
        ...
        if (method is null)
        {
            context.Commmon.Error?.WriteLine ($"Can't find method {methodName}");
            return null;
        }
        ...
        )
    {
        ...
        var result = new Tokenizer()
        {
            ...
            Recognizers =
            {
                ...
                new DirectiveRecognizer(),
                new CharacterRecognizer(),
                new RawStringRecognizer(),
                new StringRecognizer(),
                new InterpolationRecognizer(),
                new ExternalCodeRecognizer(),
                new BigIntegerRecognizer(),
                new HexRecognizer(),
                new NumberRecognizer(),
                new IntegerRecognizer(),
                new TermRecognizer (settings.KnownTerms),
