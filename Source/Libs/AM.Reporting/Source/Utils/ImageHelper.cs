...
namespace AM.Reporting.Utils
{
    internal static class ImageHelper
    {
        ...
        public static void Save (Image image, Stream stream, ImageFormat format)
        {
            ...
            else if (image is Metafile)
            {
                ...
                using (var g = Graphics.FromImage (emf))
                {
        ...
        public static bool SaveAndConvert (Image image, Stream stream, ImageFormat format)
        {
                                           ...
                                           || format == ImageFormat.MemoryBmp)
            {
                ...
                //from mf to bitmap
                using (var metafile = image as Metafile)
        ...
        {
            var grayscaleBitmap = new Bitmap (source.Width, source.Height, source.PixelFormat);
    ...
    public static class ImageExtension
    {
        ...
        public static ImageFormat GetImageFormat (this Image bitmap)
        {
            ...
            else if (ImageFormat.Bmp.Equals (bitmap.RawFormat) ||
                     ImageFormat.MemoryBmp.Equals (bitmap.RawFormat)) // MemoryBmp format raises a GDI exception
            {
