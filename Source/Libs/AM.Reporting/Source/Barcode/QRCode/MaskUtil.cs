        ...
        public static int applyMaskPenaltyRule2 (ByteMatrix matrix)
        {
            ...
            for (var y = 0; y < height - 1; ++y)
            {
                for (var x = 0; x < width - 1; ++x)
                {
                    ...
                    if (value_Renamed == array[y][x + 1] && value_Renamed == array[y + 1][x] &&
                        value_Renamed == array[y + 1][x + 1])
                    {
                        penalty += 3;
                    }
                }
        ...
        public static int applyMaskPenaltyRule3 (ByteMatrix matrix)
        {
            ...
            for (var y = 0; y < height; ++y)
            {
                for (var x = 0; x < width; ++x)
                {
                    ...
                    if (x + 6 < width && array[y][x] == 1 && array[y][x + 1] == 0 && array[y][x + 2] == 1 &&
                        array[y][x + 3] == 1 && array[y][x + 4] == 1 && array[y][x + 5] == 0 && array[y][x + 6] == 1 &&
                        ((x + 10 < width && array[y][x + 7] == 0 && array[y][x + 8] == 0 && array[y][x + 9] == 0 &&
                          array[y][x + 10] == 0) || (x - 4 >= 0 && array[y][x - 1] == 0 && array[y][x - 2] == 0 &&
                    ...
                    if (y + 6 < height && array[y][x] == 1 && array[y + 1][x] == 0 && array[y + 2][x] == 1 &&
                        ...
                        ((y + 10 < height && array[y + 7][x] == 0 && array[y + 8][x] == 0 && array[y + 9][x] == 0 &&
                          array[y + 10][x] == 0) || (y - 4 >= 0 && array[y - 1][x] == 0 && array[y - 2][x] == 0 &&
