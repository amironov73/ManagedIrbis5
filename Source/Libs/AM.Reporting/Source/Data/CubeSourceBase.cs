...
namespace AM.Reporting.Data
{
    ...
    public abstract class CubeSourceBase : DataComponentBase
    {
        ...
        ///
        /// </summary>
        public int XAxisFieldsCount => CubeLink != null ? CubeLink.XAxisFieldsCount : 0;

        /// <summary>
        ///
        /// </summary>
        public int YAxisFieldsCount => CubeLink != null ? CubeLink.YAxisFieldsCount : 0;

        /// <summary>
        ///
        /// </summary>
        public int MeasuresCount => CubeLink != null ? CubeLink.MeasuresCount : 0;

        /// <summary>
        ///
        /// </summary>
        public int MeasuresLevel => CubeLink != null ? CubeLink.MeasuresLevel : 0;

        /// <summary>
        ///
        /// </summary>
        public bool MeasuresInXAxis => CubeLink != null ? CubeLink.MeasuresInXAxis : false;

        /// <summary>
        ///
        /// </summary>
        public bool MeasuresInYAxis => CubeLink != null ? CubeLink.MeasuresInYAxis : false;

        /// <summary>
        ///
        /// </summary>
        public int DataColumnCount => CubeLink != null ? CubeLink.DataColumnCount : 0;

        /// <summary>
        ///
        /// </summary>
        public int DataRowCount => CubeLink != null ? CubeLink.DataRowCount : 0;

        /// <summary>
        ///
        /// </summary>
        public bool SourceAssigned => CubeLink != null;
