...
namespace AM.Reporting
{
    ...
    public sealed class AssemblyInitializer : AssemblyInitializerBase
    {
        ...
        public AssemblyInitializer()
        {
            ...
            RegisteredObjects.Add (typeof (LineObject), "ReportPage,Shapes", 107, "Objects,Shapes,DiagonalLine", 1,
                true);
            RegisteredObjects.Add (typeof (LineObject), "ReportPage,Shapes", 150, "Objects,Shapes,DiagonalLine", 2,
                true);
            RegisteredObjects.Add (typeof (LineObject), "ReportPage,Shapes", 151, "Objects,Shapes,DiagonalLine", 3,
                true);
            RegisteredObjects.Add (typeof (LineObject), "ReportPage,Shapes", 152, "Objects,Shapes,DiagonalLine", 4,
                true);
            ...
            RegisteredObjects.Add (typeof (SimpleProgressGauge), "ReportPage,Gauge", 140,
                "Objects,Gauge,SimpleProgress", 0, false);
