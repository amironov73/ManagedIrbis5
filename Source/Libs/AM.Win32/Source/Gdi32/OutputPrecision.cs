...
/* OutputPrecision.cs -- the font output precision
...
/// <summary>
/// The font output precision. The output precision defines
/// how closely the output must match the requested font's
/// height, width, character orientation, escapement,
...
public enum OutputPrecision
{
    ...
    /// <summary>
    /// Instructs the font mapper to choose a TrueType font
    ...
    /// <summary>
    /// Instructs the font mapper to choose a raster font
    /// when the system contains multiple fonts with the same name.
    /// </summary>
    OUT_RASTER_PRECIS = 6,
    ...
    /// If there are no PostScript fonts installed in the system,
    /// the font mapper returns to default behavior.
    /// </summary>
