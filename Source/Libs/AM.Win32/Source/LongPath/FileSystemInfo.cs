...
public abstract class FileSystemInfo
{
    ...
    public DateTime CreationTime
    {
        get
        {
            if (Common.IsRunningOnMono() && Common.IsPlatformUnix())
            {
                return SystemInfo.CreationTime;
            }
    ...
    private static void ThrowLastWriteTimeUtcIOError (int errorCode, string maybeFullPath)
    {
        ...
        switch (errorCode)
        {
            ...
            case NativeMethods.ERROR_ALREADY_EXISTS:
                ...
                throw new System.IO.IOException (string.Format ("File {0}", str),
            ...
            case NativeMethods.ERROR_INVALID_PARAMETER:
                throw new System.IO.IOException (NativeMethods.GetMessage (errorCode),
                    NativeMethods.MakeHRFromErrorCode (errorCode));
    ...
    public DateTime LastAccessTime
    {
        get
        {
            if (Common.IsRunningOnMono() && Common.IsPlatformUnix())
            {
                return SystemInfo.LastAccessTime;
            }
