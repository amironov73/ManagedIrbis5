...
/* SetWindowPosFlags.cs -- specifies a combination of the values that affect the size and position of the window
...
{
    /// <summary>
    /// Specifies a combination of the values that affect the size
    ...
    public enum SetWindowPosFlags
    {
        ...
        /// <summary>
        /// Sends a WM_NCCALCSIZE message to the window, even if the
        ...
        /// area are saved and copied back into the client area after
        ...
        /// the request to the thread that owns the window. This
        /// prevents the calling thread from blocking its execution
