...
public class RichString
{
        ...
        )
    {
        ...
        {
            HaloWidth (haloWidth.Value);
        }

        if (haloBlur.HasValue)
        {
            HaloBlur (haloBlur.Value);
        }
    ...
    /// <returns>A reference to the same RichString instance</returns>
    public RichString StrikeThrough (StrikeThroughStyle value = StrikeThroughStyle.Solid) =>
        Append (new StrikeThroughItem (value));
    ...
    private ParagraphInfo ParagraphForCodePointIndex (int index)
    {
        for (var i = 1; i < _paragraphs.Count; i++)
        {
    ...
    private RichString Append (Item item)
    {
    ...
    private class FontFamilyItem : Item
    {
    ...
    private class FontSizeItem : Item
    {
    ...
    private class FontWeightItem : Item
    {
    ...
    private class FontWidthItem : Item
    {
        ...
        private SKFontStyleWidth _value;
    ...
    private class FontItalicItem : Item
    {
    ...
    private class UnderlineItem : Item
    {
    ...
    private class StrikeThroughItem : Item
    {
        ...
        private StrikeThroughStyle _value;
    ...
    private class LineHeightItem : Item
    {
    ...
    private class TextColorItem : Item
    {
    ...
    private class BackgroundColorItem : Item
    {
    ...
    private class HaloColorItem : Item
    {
    ...
    private class HaloWidthItem : Item
    {
    ...
    private class HaloBlurItem : Item
    {
    ...
    private class LetterSpacingItem : Item
    {
    ...
    private class FontVariantItem : Item
    {
    ...
    private class TextDirectionItem : Item
    {
