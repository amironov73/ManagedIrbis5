...
public class AvaloniaPropertyExtensionsGenerator : ISourceGenerator
{
    ...
    public string GetExpressionBindingSetterExtension(string controlTypeName, FieldDeclarationSyntax field)
    {
        ...
        var extensionText =
            $"public static {controlTypeName} {extensionName}(this {controlTypeName} control, Func<{valueTypeSource}> func, Action<{valueTypeSource}>? onChanged = null, [CallerArgumentExpression(\"func\")] string? expression = null)\n" +
