...
namespace AM.IO
{
    ...
    public sealed class FileSignature
    {
        ...
        {
            new () { Main = "zip",  Aliases = new [] {"jar", "odt", "ods", "odp", "docx", "xlsx", "pptx", "vdsx", "apk", "aar"}},
        ...
        /// </summary>
        public static readonly FileSignature Asf = new ("asf", new byte[] {0x30, 0x26, 0xB2, 0x75, 0x8E, 0x66, 0xCF, 0x11});
        ...
        /// </summary>
        public static readonly FileSignature Doc = new ("doc", new byte[] {0xD0, 0xCF, 0x11, 0xE0, 0xA1, 0xB1, 0x1A, 0xE1});

        /// <summary>
        /// DjVu document.
        /// </summary>
        public static readonly FileSignature Djvu = new ("djvu", new byte[] {0x41, 0x54, 0x26, 0x54, 0x46, 0x4F, 0x52, 0x4D});
        ...
        /// </summary>
        public static readonly FileSignature Png = new ("png", new byte[] {0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A});
        ...
        /// </summary>
        public static readonly FileSignature Rar5 = new("rar", new byte[] {0x52, 0x61, 0x72, 0x21, 0x1A, 0x07, 0x01, 0x00});
        ...
        /// tar archive.
        /// </summary>
        public static readonly FileSignature Tar = new ("tar", new byte[] {0x75, 0x73, 0x74, 0x61, 0x72, 0x00, 0x30, 0x30}, 0x101);
        ...
        /// tar archive.
        /// </summary>
        public static readonly FileSignature Ustar = new ("tar", new byte[] {0x75, 0x73, 0x74, 0x61, 0x72, 0x20, 0x20, 0x00}, 0x101);

        /// <summary>
        /// Windows media video.
        /// </summary>
        public static readonly FileSignature Vmv = new ("wmv", new byte[] {0xA6, 0xD9, 0x00, 0xAA, 0x00, 0x62, 0xCE, 0x6C});
