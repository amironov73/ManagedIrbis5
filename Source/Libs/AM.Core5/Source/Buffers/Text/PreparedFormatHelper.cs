...
{
    internal static Utf16FormatSegment[] Utf16Parse 
        (
            string format
        )
    {
        ...
        while (true)
        {
            ...
            list.Add (new Utf16FormatSegment (indexParse.LastIndex - indexParse.FormatString.Length - 1,
                indexParse.FormatString.Length, indexParse.Index, indexParse.Alignment));
        }
        ...
        while (true)
        {
            while (i < len)
            {
                ...
                if (size != 0)
                {
                    ...
                    list.Add (new Utf8FormatSegment (bufOffset, utf8size, Utf8FormatSegment.NotFormatIndex, default,
                        0));
                    bufOffset += utf8size;
                }
            ...
            copyFrom = indexParse.LastIndex; // continue after '}'
            i = indexParse.LastIndex;
            list.Add (new Utf8FormatSegment (0, 0, indexParse.Index, StandardFormat.Parse (indexParse.FormatString),
