...
public abstract class EasyBinding
{
    ...
    static EasyBinding BindExpression
        (
            Expression expr
        )
    {
...
//						}
    ...
    internal static void RemoveMemberChangeAction
        (
            MemberChangeAction sub
        )
    {
    ...
    /// <param name="changeId">Change identifier</param>
    public static void InvalidateMember
        (
            object? target,
            MemberInfo member,
            int changeId = 0
    ...
    public static void InvalidateMember<T>
        (
            Expression<Func<T>> lambdaExpr
        )
    {
