    ...
    : IEnumerable<T>, ISerializable, IDeserializationCallback
{
    ...
    {
        var oldTable = table; // Move all the items from this table to the new table.
    ...
    public float LoadFactor
    {
        ...
        set
        {
            ...
            var maybeExpand = value < loadFactor; // May need to expand or shrink the table -- which?
    ...
    internal void PrintStats()
    {
        ...
        Console.WriteLine ("loadFactor={0}  thresholdGrow={1}  thresholdShrink={2}", loadFactor, thresholdGrow,
            thresholdShrink);
