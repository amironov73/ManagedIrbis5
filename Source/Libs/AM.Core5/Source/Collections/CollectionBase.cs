...
public abstract class CollectionBase<T> : ICollection<T>, ICollection
{
    ...
    {
        throw new NotImplementedException ("This method must be overridden or re-implemented in the derived class");
    }
    ...
    public virtual void CopyTo (T[] array, int arrayIndex)
    {
        ...
        if (count < 0)
        {
            throw new IndexOutOfRangeException ("The argument may not be less than zero");
        }
        ...
        {
            throw new ArgumentException ("The array is too small to hold all of the items", nameof (arrayIndex));
        }
