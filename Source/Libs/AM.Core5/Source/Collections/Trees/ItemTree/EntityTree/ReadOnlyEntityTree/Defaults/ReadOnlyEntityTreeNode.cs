...
namespace TreeCollections
{
    ...
    public class
        ReadOnlyEntityTreeNode<TId, TItem> : ReadOnlyEntityTreeNode<ReadOnlyEntityTreeNode<TId, TItem>, TId, TItem>
    {
        /// <summary>
        /// Root constructor
        /// </summary>
        ...
        protected sealed override ReadOnlyEntityTreeNode<TId, TItem> Create (TItem item,
