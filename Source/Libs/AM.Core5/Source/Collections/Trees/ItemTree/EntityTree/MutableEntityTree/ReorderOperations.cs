...
abstract partial class MutableEntityTreeNode<TNode, TId, TItem>
{
    ...
    public virtual void OrderChildrenAscending<TOrderKey>
        (
            Func<TItem, TOrderKey> selectKey
        )
    ...
    /// <typeparam name="TOrderKey"></typeparam>
    /// <param name="selectKey">Ordering key selector</param>
    public virtual void OrderChildrenDescending<TOrderKey>
        (
            Func<TItem, TOrderKey> selectKey
        )
        where TOrderKey: IComparable
    ...
    private void OrderChildren
        (
            Func<IEnumerable<TNode>,
                IEnumerable<TNode>> reorder
        )
    {
