...
namespace TreeCollections
{
    ...
    public class
        MutableEntityTreeNode<TId, TItem> : MutableEntityTreeNode<MutableEntityTreeNode<TId, TItem>, TId, TItem>
    {
        /// <summary>
        /// Root constructor
        /// </summary>
        ...
        protected sealed override MutableEntityTreeNode<TId, TItem> Create (TItem item,
