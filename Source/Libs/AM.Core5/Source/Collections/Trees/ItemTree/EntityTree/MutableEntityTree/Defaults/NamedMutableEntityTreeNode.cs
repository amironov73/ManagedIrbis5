...
namespace TreeCollections
{
    ...
    public class
        NamedMutableEntityTreeNode<TId, TItem> : MutableEntityTreeNode<NamedMutableEntityTreeNode<TId, TItem>, TId,
            string, TItem>
    {
        ...
        protected sealed override NamedMutableEntityTreeNode<TId, TItem> Create (TItem item,
            NamedMutableEntityTreeNode<TId, TItem> parent)
        {
