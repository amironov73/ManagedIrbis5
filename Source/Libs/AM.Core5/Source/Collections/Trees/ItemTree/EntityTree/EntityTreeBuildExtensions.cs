...
public static class EntityTreeBuildExtensions
{
    ...
    public static void Build<TNode, TId, TItem, TSource>
        (
        ...
        where TNode : EntityTreeNode<TNode, TId, TItem>
    {
        ...
        parentNode.Build
            (
                p => sourceItemsGroupedByParentId[p.Id].Select (getItem),
                maxRelativeDepth
            );
    }
        ...
        where TNode: EntityTreeNode<TNode, TId, TItem>
    {
        ...
        parentNode.Build
            (
                p => orderChildren (sourceItemsGroupedByParentId[p.Id]).Select (getItem),
                maxRelativeDepth
            );
    }
}
