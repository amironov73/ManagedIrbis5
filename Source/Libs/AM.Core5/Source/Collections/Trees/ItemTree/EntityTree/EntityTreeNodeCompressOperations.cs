...
namespace TreeCollections
{
    public abstract partial class EntityTreeNode<TNode, TId, TItem>
    {
        ...
        {
            MapCompressTo (destRoot, matchesCriteria, node => node.Item, maxRelativeSearchDepth,
                maxRelativeRenderDepth);
        }
        ...
        public void CompressTo (TNode destRoot,
            ...
            int? maxRelativeRenderDepth = null)
        {
            MapCompressTo (destRoot, allowNext, matchesCriteria, node => node.Item, maxRelativeSearchDepth,
                maxRelativeRenderDepth);
        }
            ...
            where TDestNode : EntityTreeNode<TDestNode, TId, TDestItem>
        {
            ...
            MapCompressTo (PreOrder (maxRelativeSearchDepth), destRoot, matchesCriteria, mapItem,
                maxRelativeRenderDepth);
        }
            ...
            where TDestNode : EntityTreeNode<TDestNode, TId, TDestItem>
        {
            ...
            MapCompressTo (PreOrder (allowNext, maxRelativeSearchDepth), destRoot, matchesCriteria, mapItem,
                maxRelativeRenderDepth);
        }
