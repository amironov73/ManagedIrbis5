...
public abstract partial class EntityTreeNode<TNode, TId, TItem>
{
    ...
    /// <param name="maxRelativeSearchDepth">Max depth of traversal when finding matching nodes in source</param>
    /// <param name="maxRelativeRenderDepth">Max depth to build compressed version</param>
    public void MapCompressTo<TDestNode>
        (
            TDestNode destRoot,
            Func<TNode, bool> matchesCriteria,
            int? maxRelativeSearchDepth = null,
    ...
    /// <param name="maxRelativeSearchDepth">Max depth of traversal when finding matching nodes in source</param>
    /// <param name="maxRelativeRenderDepth">Max depth to build compressed version</param>
    public void MapCompressTo<TDestNode, TDestItem>
        (
            TDestNode destRoot,
            Func<TNode, bool> matchesCriteria,
        ...
        where TDestNode: EntityTreeNode<TDestNode, TId, TDestItem>
    {
        ...
        MapCompressTo
            (
                PreOrder (maxRelativeSearchDepth),
                destRoot,
                matchesCriteria,
                mapItem,
                maxRelativeRenderDepth
        ...
        where TDestNode: EntityTreeNode<TDestNode, TId, TDestItem>
    {
        ...
        MapCompressTo
            (
                PreOrder (allowNext, maxRelativeSearchDepth),
                destRoot,
                matchesCriteria,
                mapItem,
                maxRelativeRenderDepth
    ...
    private static void MapCompressTo<TDestNode, TDestItem>
        (
            IEnumerable<TNode> sourceNodes,
            TDestNode destRoot,
            Func<TNode, bool> matchesCriteria,
            Func<TNode, TDestItem> mapItem,
            int? maxRelativeRenderDepth = null
        ...
        where TDestNode: EntityTreeNode<TDestNode, TId, TDestItem>
    {
        ...
        destRoot.Build
            (
                parent => sourceDescendantNodePool[parent.Id].Select (mapItem),
                maxRelativeRenderDepth
            );
    }
}
