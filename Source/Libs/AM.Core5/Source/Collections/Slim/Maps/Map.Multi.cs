            ...
            for (int i = 0; i < _keyValues.Length; i++)
            {
                if (Comparer.Equals (key, _keyValues[i].Key))
                {
                    ...
                    if (_keyValues.Length == 4)
                    {
                        ...
                        return
                            i == 0 ? new ThreeElementKeyedMap (_keyValues[1].Key, _keyValues[1].Value,
                                _keyValues[2].Key, _keyValues[2].Value, _keyValues[3].Key, _keyValues[3].Value) :
                            i == 1 ? new ThreeElementKeyedMap (_keyValues[0].Key, _keyValues[0].Value,
                                _keyValues[2].Key, _keyValues[2].Value, _keyValues[3].Key, _keyValues[3].Value) :
                            i == 2 ? new ThreeElementKeyedMap (_keyValues[0].Key, _keyValues[0].Value,
                                _keyValues[1].Key, _keyValues[1].Value, _keyValues[3].Key, _keyValues[3].Value) :
                            new ThreeElementKeyedMap (_keyValues[0].Key, _keyValues[0].Value, _keyValues[1].Key,
                                _keyValues[1].Value, _keyValues[2].Key, _keyValues[2].Value);
                    }
                    else
                    {
                        success = true;
