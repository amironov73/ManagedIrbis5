    ...
    : IDisposable
{
    ...
    /// to the next element; false if the enumerator has passed the end
    ...
    /// <summary>Gets the element in the collection at the current
    /// position of the enumerator.</summary>
    /// <returns>The element in the collection at the current position
