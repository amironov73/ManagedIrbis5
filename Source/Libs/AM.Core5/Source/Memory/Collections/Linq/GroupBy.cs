...
public static partial class PoolingEnumerable
{
    ...
    public static IPoolingEnumerable<IPoolingGrouping<TKey, TElement>> GroupBy<TSource, TKey, TElement> (
        ...
        Pool<GroupedEnumerable<TSource, TKey, TElement>>.Get()
    ...
    public static IPoolingEnumerable<TResult> GroupBy<TSource, TKey, TResult> (
        ...
        Pool<GroupedResultEnumerable<TSource, TKey, TResult>>.Get()
    ...
    public static IPoolingEnumerable<TResult> GroupBy<TSource, TKey, TResult> (
        this IPoolingEnumerable<TSource> source, Func<TSource, TKey> keySelector,
        Func<TKey, IPoolingEnumerable<TSource>, TResult> resultSelector, IEqualityComparer<TKey> comparer) =>
        Pool<GroupedResultEnumerable<TSource, TKey, TResult>>.Get()
