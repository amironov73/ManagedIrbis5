    ...
    : IDisposable
{
        ...
        )
    {
        ...
        if (!_acceptorSocket.AcceptAsync (eventArgs))
        {
    ...
    public TcpSession? FindSession
        (
            Guid sessionId
        )
    {
        // Try to find the required session
        return Sessions.TryGetValue (sessionId, out var result) ? result : null;
    }
    ...
    internal void OnConnectingInternal
        (
            TcpSession session
        )
    {
    ...
    internal void OnDisconnectingInternal
        (
            TcpSession session
        )
    {
