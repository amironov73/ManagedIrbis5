...
/// It allows to send GET, POST, PUT, DELETE requests and receive HTTP result.
/// </summary>
    ...
    : TcpClient
{
    ...
    /// <inheritdoc cref="TcpClient.OnReceived"/>
    ...
    /// <inheritdoc cref="TcpClient.OnDisconnected"/>
    ...
    : HttpClient
{
    ...
    /// <param name="timeout">Current HTTP request timeout (default is 1 minute)</param>
    /// <returns>HTTP request Task</returns>
    public Task<HttpResponse> SendPostRequest
        (
            string url,
            string content,
            TimeSpan? timeout = null
    ...
    /// <inheritdoc cref="TcpClient.OnConnected"/>
    ...
    /// <inheritdoc cref="HttpClient.OnDisconnected"/>
    protected override void OnDisconnected()
    {
    ...
    /// <inheritdoc cref="HttpClient.OnReceivedResponse"/>
    ...
    /// <inheritdoc cref="HttpClient.OnReceivedResponseError"/>
    ...
    /// <inheritdoc cref="TcpClient.Dispose(bool)"/>
