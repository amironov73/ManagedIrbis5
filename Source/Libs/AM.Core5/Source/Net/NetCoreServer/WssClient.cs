    ...
    : HttpsClient, IWebSocket
{
    ...
    /// <inheritdoc cref="SslClient.Connect"/>
    ...
    /// <inheritdoc cref="SslClient.ConnectAsync"/>
    ...
    ///
    /// </summary>
    protected override void OnReceivedResponseHeader
        (
