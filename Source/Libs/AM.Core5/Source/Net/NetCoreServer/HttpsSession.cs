    ...
    : SslSession
{
    ...
    public bool SendResponseBodyAsync
        (
            string body
        )
    {
    ...
    /// <inheritdoc cref="SslSession.OnReceived"/>
    ...
    /// <inheritdoc cref="SslSession.OnDisconnected"/>
    ...
    protected virtual void OnReceivedRequestHeader
        (
            HttpRequest request
        )
    {
    ...
    /// <param name="request">HTTP request</param>
    protected virtual void OnReceivedRequest
        (
            HttpRequest request
        )
    {
    ...
    protected virtual void OnReceivedCachedRequest
        (
            HttpRequest request,
            byte[] content
        )
    ...
    protected virtual void OnReceivedRequestError
        (
            HttpRequest request,
            string error
        )
    ...
    private void OnReceivedRequestInternal
        (
            HttpRequest request
        )
    {
