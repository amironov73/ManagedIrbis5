...
public class HttpRequest
{
    ...
    public override string ToString()
    {
        ...
        builder.AppendLine ($"Request method: {Method}");
        builder.AppendLine ($"Request URL: {Url}");
        builder.AppendLine ($"Request protocol: {Protocol}");
        builder.AppendLine ($"Request headers: {Headers}");
