    ...
    : IDisposable
{
        ...
        )
    {
        ...
        switch (eventArgs.LastOperation)
        {
            case SocketAsyncOperation.ReceiveFrom:
                ProcessReceiveFrom (eventArgs);
                break;

            case SocketAsyncOperation.SendTo:
                ProcessSendTo (eventArgs);
                break;
        ...
        )
    {
        ...
        // Call the datagram received handler
        OnReceived (eventArgs.RemoteEndPoint!, _receiveBuffer.Data, 0, size);
    ...
    /// </summary>
    /// <param name="address">IP address</param>
    protected virtual void OnJoinedMulticastGroup
        (
            IPAddress address
        )
    {
    ...
    /// </summary>
    /// <param name="address">IP address</param>
    protected virtual void OnLeftMulticastGroup
        (
            IPAddress address
        )
    {
