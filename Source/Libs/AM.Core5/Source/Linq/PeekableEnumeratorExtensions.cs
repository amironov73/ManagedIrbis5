...
public static class PeekableEnumeratorExtensions
{
    ...
    /// <returns></returns>
    public static PeekableEnumerator<T> GetPeekableEnumerator<T>
        (
    ...
    public static IEnumerable<T> TakeWhile<T>
        (
            this PeekableEnumerator<T> enumerator,
    ...
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    public static IEnumerable<T> TakeSliceByFirst<T>
        (
            this PeekableEnumerator<T> enumerator,
            Predicate<T> isFirst
        )
    ...
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    public static IEnumerable<T> TakeSliceByLast<T>
        (
            this PeekableEnumerator<T> enumerator,
            Predicate<T> isLast
        )
    ...
    /// <typeparam name="T"></typeparam>
    /// <returns></returns>
    public static bool TakeIfNot<T>
        (
            this PeekableEnumerator<T> enumerator,
            Predicate<T> predicate,
            [MaybeNullWhen (false)] out T value
