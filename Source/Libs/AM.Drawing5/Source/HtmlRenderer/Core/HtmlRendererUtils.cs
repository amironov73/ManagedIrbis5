...
namespace AM.Drawing.HtmlRenderer.Core;
...
public static class HtmlRendererUtils
{
    ...
    /// is ignored.<br/>
    /// </summary>
    /// <param name="graphics">the graphics used for layout</param>
        ...
        )
    {
        ...
        if (autoSize || autoSizeHeightOnly)
        {
            ...
            else if (Math.Abs (size.Height - htmlContainer.ActualSize.Height) > 0.01)
            {
                ...
                {
                    return Layout (graphics, htmlContainer, size, minSize, maxSize, false, true);
                }
            }
        }
