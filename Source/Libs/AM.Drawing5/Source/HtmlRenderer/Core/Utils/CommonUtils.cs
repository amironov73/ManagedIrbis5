...
internal static class CommonUtils
{
    ...
    {
        "あ", "ぃ", "ぅ", "ぇ", "ぉ", "か", "き", "く", "け", "こ", "さ", "し", "す", "せ", "そ", "た", "ち", "つ", "て", "と", "な", "に",
        "ぬ", "ね", "の", "は", "ひ", "ふ", "へ", "ほ", "ま", "み", "む", "め", "も", "ゃ", "ゅ", "ょ", "ら", "り", "る", "れ", "ろ", "ゎ",
        "ゐ", "ゑ", "を", "ん"
    };
    ...
    public static TValue? GetFirstValueOrDefault<TKey, TValue>
        (
    ...
    public static FileInfo? TryGetFileInfo (string path)
    {
        ...
        {
            Debug.WriteLine (nameof (TryGetFileInfo));
        }
    ...
    public static FileInfo GetLocalfileName (Uri imageUri)
    {
        ...
        var restOfUri = absoluteUri.Substring (lastSlash + 1);
        var indexOfParams = restOfUri.IndexOf ('?');
        if (indexOfParams == -1)
        {
            var ext = ".png";
            var indexOfDot = restOfUri.IndexOf ('.');
            if (indexOfDot > -1)
            {
