    ...
    : BarCode
{
    ...
    internal abstract void CalcThinBarWidth
        (
            BarCodeRenderInfo info
        );
    ...
    /// <inheritdoc cref="BarCode.InitRendering"/>
    internal override void InitRendering
        (
            BarCodeRenderInfo info
        )
    {
