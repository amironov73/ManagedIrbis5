    ...
    : PdfDictionary
{
    ...
    /// </summary>
    public double Zoom { get; set; } = double.NaN;
    ...
    /// </summary>
    public bool HasChildren => _outlines is { Count: not 0 };
...
#pragma warning disable 162
        ...
        var type = destination.Elements[1] as PdfName;
        if (type != null)
        {
            PageDestinationType =
                (PdfPageDestinationType)Enum.Parse (typeof (PdfPageDestinationType), type.Value.Substring (1), true);
