...
#pragma warning disable CS0612
                ...
                authority == AuthorityType.periodicsinglepaymentsepa)
            {
                ...
                {
                    bezahlCodePayload +=
                        $"periodicfirstexecutiondate={periodicFirstExecutionDate:ddMMyyyy}&";
                }

                if (periodicLastExecutionDate != DateTime.MinValue)
                {
                    bezahlCodePayload +=
                        $"periodiclastexecutiondate={periodicLastExecutionDate:ddMMyyyy}&";
                }
            }
#pragma warning restore CS0612
        }
    ...
    /// </summary>
    public sealed class BezahlCodeException
        : Exception
    {
        /// <summary>
