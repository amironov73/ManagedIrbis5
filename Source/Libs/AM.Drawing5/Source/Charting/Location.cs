...
/// <summary>
/// A class than contains information about the position
/// of an object on the graph.
/// </summary>
[Serializable]
    ...
    : ICloneable, ISerializable
{
    ...
    /// <param name="coordType">The <see cref="CoordType"/> enum that specifies the
    /// units for <see paramref="x"/> and <see paramref="y"/></param>
    /// <param name="alignH">The <see cref="Charting.AlignH"/> enum that specifies
    /// the horizontal alignment of the object with respect to the (x,y) location</param>
    /// <param name="alignV">The <see cref="Charting.AlignV"/> enum that specifies
