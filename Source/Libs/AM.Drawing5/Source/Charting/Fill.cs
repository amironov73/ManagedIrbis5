    ...
    : ISerializable, ICloneable
{
    ...
    /// in the horizontal direction.  This value is a <see cref="Charting.AlignH"/> enumeration.
    ...
    /// <summary>
    /// Private field that determines how the brush will be aligned with the filled object
    /// in the vertical direction.  This value is a <see cref="Charting.AlignV"/> enumeration.
    /// This field only applies if <see cref="IsScaled"/> is false.
    /// properties.
    /// </summary>
    /// <seealso cref="AlignH"/>
