...
public class GraphPane
    : PaneBase, ICloneable, ISerializable
{
    #region Events
    ...
    /// <summary>Private field instance of the <see cref="Charting.XAxis"/> class.  Use the
    ...
    /// <summary>Private field instance of the <see cref="Charting.YAxisList"/> class.  Use the
    /// public property <see cref="GraphPane.YAxisList"/> to access this class.</summary>
    private YAxisList _yAxisList;

    /// <summary>Private field instance of the <see cref="Charting.Y2AxisList"/> class.  Use the
    /// public property <see cref="GraphPane.Y2AxisList"/> to access this class.</summary>
    private Y2AxisList _y2AxisList;

    /// <summary>Private field instance of the <see cref="Charting.CurveList"/> class.  Use the
    ...
    /// graphs will be displayed. See the <see cref="Charting.LineType"/> enum
    ...
    public new struct Default
    {
        ...
        /// <see cref="Charting.LineType"/> for more information.
        /// </summary>
    ...
    /// <summary>
    /// Calculate the <see cref="Charting.Chart.Rect"/> based on the <see cref="PaneBase.Rect"/>.
    /// </summary>
...
//			minSpaceT = Math.Max( minSpaceT, spaceT );
    ...
    /// the <see cref="Charting.CurveList" /> Add() method.
    /// </summary>
    ...
    /// should contain <see cref="StockPoint" /> objects instead of <see cref="PointPair" />
    ...
    /// </summary>
    /// <remarks>This method implicitly assumes that <see cref="Charting.Chart.Rect"/>
    /// has already been calculated via <see cref="AxisChange()"/> or
    /// <see cref="Draw"/> methods, or the <see cref="Charting.Chart.Rect"/> is
    /// set manually (see <see cref="Charting.Chart.IsRectAuto"/>).</remarks>
    ...
    /// has already been calculated via <see cref="AxisChange()"/> or
    /// <see cref="Draw"/> methods, or the <see cref="Charting.Chart.Rect"/> is
    /// set manually (see <see cref="Charting.Chart.IsRectAuto"/>).
