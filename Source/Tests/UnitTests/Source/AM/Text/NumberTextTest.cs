...
public class NumberTextTest
{
    ...
    [TestMethod]
    [Description ("Конструктор от строки")]
    ...
    [TestMethod]
    [Description ("Конструктор от ReadOnlyMemory")]
    public void NumberText_Construction_3()
    {
        var chars = "Hello1".ToCharArray();
        var number = new NumberText (chars);
        Assert.IsFalse (number.Empty);
    }
    ...
    public void NumberText_Max_1()
    {
        NumberText first = "hello2";
        NumberText second = "hello010";
        var max = NumberText.Max (first, second);
    ...
    public void NumberText_Min_1()
    {
        NumberText first = "hello2";
        NumberText second = "hello010";
        var min = NumberText.Min (first, second);
    ...
    public void NumberText_GetDifference_1()
    {
        ...
        var difference = (int)first.GetDifference (second);
    ...
    public void NumberText_GetValue_1()
    {
        ...
        var value = (int)number.GetValue (0);
    ...
    {
        NumberText number = "Hello001";
        var value = (int)number.GetValue (1000);
        ...
        )
    {
        ...
        var second = bytes.RestoreObjectFromMemory<NumberText>();
    ...
    {
        var first = new NumberText ("Hello1");
        var second = new NumberText ("Hello01");
        Assert.IsTrue (first.CompareTo (second) == 0);
    }
    ...
    {
        var nonSorted = new List<NumberText>
        {
            "hello4", "hello0001", "hello002", "hello03"
        };

        var sorted = NumberText.Sort (nonSorted).ToArray();
