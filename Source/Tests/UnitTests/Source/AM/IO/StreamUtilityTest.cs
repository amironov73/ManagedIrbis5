...
[TestClass]
public sealed class StreamUtilityTest
{
    [TestMethod]
    [Description ("Простое добавление в конец потока")]
        ...
        )
    {
        ...
        var result = StreamUtility.Compare (firstStream, secondStream);

        return result;
    }

    [TestMethod]
    [Description ("Различные варианты сравения")]
    public void StreamUtility_Compare_1()
    {
    ...
    [TestMethod]
    [Description ("Чтение логического значения: удачное")]
    ...
    [Description ("Чтение логического значения: неудачное")]
