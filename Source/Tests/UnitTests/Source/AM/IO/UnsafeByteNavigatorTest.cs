...
namespace UnitTests.AM.IO
{
        ...
        : Common.CommonUnitTest
    {
        ...
        {
            UnsafeByteNavigator navigator = _GetNavigator();
        ...
        {
            UnsafeByteNavigator first = _GetNavigator();
            UnsafeByteNavigator second = first.Clone();
        ...
        public unsafe void UnsafeByteNavigator_PeekChar_1()
        {
            ...
            fixed (byte* ptr = data)
            {
                UnsafeByteNavigator navigator = new UnsafeByteNavigator(ptr, data.Length);
