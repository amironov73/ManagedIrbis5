    ...
    : Common.CommonUnitTest
{
    ...
    {
        return new Field (AthraLinkedTitle.Tag)
            .Add ('a', "Иванов")
            .Add ('b', "И. И.")
            .Add ('g', "Иван Иванович")
            .Add ('f', "1991-")
    ...
    public void AthraLinkedTitle_ToXml_1()
    {
        ...
        Assert.AreEqual
            (
                "<related><surname>Иванов</surname><initials>И. И.</initials><extension>Иван Иванович</extension><dates>1991-</dates><relatedRecord>84/И 20-425445</relatedRecord></related>",
                XmlUtility.SerializeShort (athra)
            );
    }
    ...
    public void AthraLinkedTitle_ToJson_1()
    {
        ...
        Assert.AreEqual
            (
                "{}",
                JsonUtility.SerializeShort (athra)
            );
