...
{
    [TestClass]
    public sealed class AthraSeeTest
        : Common.CommonUnitTest
    {
        private Field _GetField() => new Field (AthraSee.Tag)
            .Add ('a', "Иванов")
            .Add ('b', "И. И.")
            .Add ('g', "Иван Иванович")
            .Add ('f', "1991-");

        private AthraSee _GetAthraSee() => new ()
        {
            Surname = "Иванов",
            Initials = "И. И.",
        ...
        public void AthraSee_Construction_1()
        {
            var athra = new AthraSee();
        ...
        public void AthraSee_ApplyTo_1()
        {
            var expected = _GetField();
            var actual = new Field();
            var athra = _GetAthraSee();
        ...
        public void AthraSee_ParseField_1()
        {
            var field = _GetField();
            var actual = AthraSee.ParseField (field);
            var expected = _GetAthraSee();
            ...
            )
        {
            ...
            var second = bytes.RestoreObjectFromMemory<AthraSee>();
        ...
        public void AthraSee_Serialization_1()
        {
            var athra = new AthraSee();
        ...
        public void AthraSee_ToXml_1()
        {
            var athra = new AthraSee();
            Assert.AreEqual ("<see />", XmlUtility.SerializeShort (athra));

            athra = _GetAthraSee();
            Assert.AreEqual ("<see><surname>Иванов</surname><initials>И. И.</initials><extension>Иван Иванович</extension><dates>1991-</dates></see>",
                XmlUtility.SerializeShort (athra));
        }

        [TestMethod]
        [Description ("JSON-представление")]
        public void AthraSee_ToJson_1()
        {
            var athra = new AthraSee();
        ...
        public void AthraSee_ToString_1()
        {
            var athra = new AthraSee();
