...
namespace UnitTests.ManagedIrbis.Fields
{
        ...
        : Common.CommonUnitTest
    {
        ...
        private Record _GetRecord()
        {
            ...
            result.Fields.Add(new Field(200, "^AСовременная драматургия^Eлитературно-художественный журнал^LСоврем. драматургия^FМ-во культуры РФ, Регион. благотворит. обществ. Фонд развития и поощрения драматургии, Редакция журнала"));
        ...
        public void QuarterlyOrderInfo_ParseField_1()
        {
            ...
            //}
            var actual = QuarterlyOrderInfo.Parse(field);
        ...
        public void QuarterlyOrderInfo_ParseRecord_1()
        {
            ...
            var orders = QuarterlyOrderInfo.Parse(record);
        ...
        public void QuarterlyOrderInfo_ToJson_1()
        {
            ...
            order = _GetOrderInfo();
            Assert.AreEqual("{\"period\":\"2017/0\",\"issues\":\"4\",\"first\":\"1\",\"last\":\"4\",\"totalPrice\":\"775.30\",\"issuePrice\":\"1=193.82;\",\"code\":\"h\",\"periodicity\":\"4\",\"unknown\":[]}", JsonUtility.SerializeShort(order));
        }
