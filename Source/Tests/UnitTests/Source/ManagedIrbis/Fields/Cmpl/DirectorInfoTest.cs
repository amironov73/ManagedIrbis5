    ...
    : Common.CommonUnitTest
{
    ...
    {
        return new Field (DirectorInfo.Tag)
    ...
    public void DirectorInfo_ToXml_1()
    {
        ...
        Assert.AreEqual
            (
                "<director><title>Директор Иркутской областной государственной универсальной научной библиотеки</title><abbreviation>Директор ИОГУНБ</abbreviation><director-name>Сулейманова Л. А.</director-name></director>",
                XmlUtility.SerializeShort (director)
            );
    }
    ...
    public void DirectorInfo_ToJson_1()
    {
        ...
        Assert.AreEqual
            (
                "{}",
                JsonUtility.SerializeShort (director)
            );
    ...
    public void DirectorInfo_ToString_1()
    {
        ...
        Assert.AreEqual
        (
            "Title: Директор Иркутской областной государственной универсальной научной библиотеки, DirectorName: Сулейманова Л. А.",
            director.ToString()
        );
    }
}
