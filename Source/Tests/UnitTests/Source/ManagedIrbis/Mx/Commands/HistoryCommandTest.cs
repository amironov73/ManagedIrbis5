...
{
    [TestClass]
    public sealed class HistoryCommandTest
        : CommonMxCommandTest
    {
        [TestMethod]
        [Description ("Конструктор по умолчанию")]
        public void HistoryCommand_Construction_1()
        {
        ...
        public void HistoryCommand_Execute_1()
        {
            using var executive = GetExecutive();
            using var command = new HistoryCommand();
        ...
        public void HistoryCommand_ToString_1()
        {
            var command = new HistoryCommand();
            Assert.AreEqual ("history", command.ToString());
        }
    }
}
