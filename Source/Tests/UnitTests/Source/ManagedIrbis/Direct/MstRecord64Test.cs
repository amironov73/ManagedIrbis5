...
public class MstRecord64Test
{
    ...
    [TestMethod]
    [Description ("Декодирование записи")]
    ...
    [TestMethod]
    [Description ("Кодирование свойств")]
    ...
    [TestMethod]
    [Description ("Подготовка к сохранению записи в поток")]
    ...
    public void MstRecord64_ToString_1()
    {
        ...
        Assert.AreEqual
            (
                "Leader: Mfn: 0, Length: 0, Previous: 0, Base: 0, Nvf: 0, Status: 0, Version: 0\nDictionary: ",
        ...
        Assert.AreEqual
            (
                "Leader: Mfn: 123, Length: 0, Previous: 0, Base: 0, Nvf: 0, Status: 0, Version: 0\nDictionary: Tag: 100, Position: 111, Length: 10, Text: Hello\n",
                record.ToString().DosToUnix()
            );
    }
}
