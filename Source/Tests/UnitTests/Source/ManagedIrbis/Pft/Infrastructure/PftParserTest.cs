...
namespace UnitTests.ManagedIrbis.Pft.Infrastructure
{
    ...
    public class PftParserTest
    {
            ...
            )
        {
            ...
            var list = lexer.Tokenize(text);
            var parser = new PftParser(list);
        ...
        {
            var program = _Parse(string.Empty);
        ...
        public void PftParser_ParseA_1()
        {
            ...
            var actual = _Parse("if a(v200^a) then fi");
        ...
        public void PftParser_ParseAbs_1()
        {
            ...
            var actual = _Parse("f(abs(-123),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_All_1()
        {
            ...
            var actual = _Parse("if all(v910^a='0') then fi");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Any_1()
        {
            ...
            var actual = _Parse("if any(v910^a='0') then fi");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_At_1()
        {
            ...
            var actual = _Parse("'Before' @inclusion 'After'");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Assignment_1()
        {
            ...
            var actual = _Parse("$x='Hello','world';");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Bang_1()
        {
            ...
            var actual = _Parse("'The Big ' ! 'Bang'");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Blank_1()
        {
            ...
            var actual = _Parse("if blank(v910^b) then fi");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Break_1()
        {
            ...
            var actual = _Parse("'Spring' break");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Ceil_1()
        {
            ...
            var actual = _Parse("f(ceil(3.14),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_CodeBlock_1()
        {
            ...
            var actual = _Parse("{{{Console.WriteLine(\"Hello\");}}}");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Comment_1()
        {
            ...
            var actual = _Parse("'Hello' /*Comment\n 'world'");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Eat_1()
        {
            ...
            var actual = _Parse("'Hello' [[[ 'new' ]]] 'world'");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Empty_1()
        {
            ...
            var actual = _Parse("if empty(v910^b) then fi");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_F_1()
        {
            ...
            var actual = _Parse("f(3+0.14,10,5)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_False_1()
        {
            ...
            var actual = _Parse("if false then fi");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_FieldAssignment_1()
        {
            ...
            var actual = _Parse("v300='First'/'Second'/'Third';");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_First_1()
        {
            ...
            var actual = _Parse("f(first(v910^a='0'))");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Floor_1()
        {
            ...
            var actual = _Parse("f(floor(3.14),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Fmt_1()
        {
            ...
            var actual = _Parse("fmt(3+0.14,'F2')");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_For_1()
        {
            ...
            var actual = _Parse("for $x=1; $x < 10; $x = $x + 1; do 'Hello' / end");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_ForEach_1()
        {
            ...
            var actual = _Parse("foreach $x in v200^a v200^e 'Hello'\ndo\n\t$x\n\t#\nend");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Frac_1()
        {
            ...
            var actual = _Parse("f(frac(3.14),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_From_1()
        {
            ...
            var actual = _Parse("from $x in (v692^b/)\nwhere $x:'2008'\n"
                                + "select 'Item: ', $x,\norder $x,\nend");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Have_1()
        {
            ...
            var actual = _Parse("if have($x) then fi");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_L_1()
        {
            ...
            var actual = _Parse("f(l('K=ATLAS'),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Last_1()
        {
            ...
            var actual = _Parse("f(last(v910^a='0'))");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Mfn_2()
        {
            ...
            var actual = _Parse("mfn(10) v200^a");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_ParallelGroup_1()
        {
            ...
            var actual = _Parse("parallel ( v910^b , / )");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Pow_1()
        {
            ...
            var actual = _Parse("f(pow(2,8),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Ref_1()
        {
            ...
            var actual = _Parse("ref(3,v200^a, \" : \"v200^e, \" / \"v200^f)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Round_1()
        {
            ...
            var actual = _Parse("f(round(3.14),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Rsum_1()
        {
            ...
            var actual = _Parse("f(rsum('123;321'),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Rsum_2()
        {
            ...
            var actual = _Parse("f(ravr('123;321'),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Rsum_3()
        {
            ...
            var actual = _Parse("f(rmin('123;321'),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Rsum_4()
        {
            ...
            var actual = _Parse("f(rmax('123;321'),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Sign_1()
        {
            ...
            var actual = _Parse("f(sign(3.14),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_True_1()
        {
            ...
            var actual = _Parse("if true then fi");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Trunc_1()
        {
            ...
            var actual = _Parse("f(trunc(3.14),0,0)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_V_1()
        {
            ...
            var actual = _Parse("v200^av200^e");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_V_4()
        {
            ...
            var actual = _Parse("\" : \"v200^e,\" / \"v200^f");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_Val_1()
        {
            ...
            var actual = _Parse("f(val('2222.113'),1,2)");
            _Compare(expected, actual);
        }
        ...
        public void PftParser_While_1()
        {
            ...
            var actual = _Parse("'Почему это круто?'#\n"
                                + "'================='##\n\n"
                                + "$x=0;\n\n"
                                + "while $x < 10\n"
                                + "do\n"
