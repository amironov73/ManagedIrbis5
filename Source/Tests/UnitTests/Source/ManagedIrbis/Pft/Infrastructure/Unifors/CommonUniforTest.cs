...
namespace UnitTests.ManagedIrbis.Pft.Infrastructure.Unifors
{
        ...
        : Common.CommonUnitTest
    {
        ...
        protected virtual Record GetRecord()
        {
            ...
            result.Fields.Add(Parse(951, "^AПример PDF-файла.PDF^TПример внешнего объекта в виде PDF-файла - с постраничным просмотром^N14"));
            ...
            result.Fields.Add(Parse(691, "^! 3^IАКТ^DАктинометрия^SОПД^BФЭиОЭП^KУМО^AЗИ^Vспц^Oд/о^C310700^F3^WАКТ/3^GОсн^0ЗИ310700спцд/о-S3"));
            result.Fields.Add(Parse(907, "^A20140703^B1^C"));
            result.Fields.Add(Parse(701, "^AБабич^BА.М.^U2"));
            result.Fields.Add(Parse(200, "^AКуда пойти учиться?^EИнформ. - реклам. справ^FЗ. М. Акулова, А. М. Бабич ; ред. А. С. Павловский [и др.]"));
