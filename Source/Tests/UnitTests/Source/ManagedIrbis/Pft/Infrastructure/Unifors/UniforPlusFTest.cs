...
namespace UnitTests.ManagedIrbis.Pft.Infrastructure.Unifors
{
    ...
    public class UniforPlusFTest
    {
            ...
            )
        {
            ...
            var actual = context.GetProcessedOutput().DosToUnix();
