...
{
    [TestClass]
    public class GblProtocolLineTest
    {
        [TestMethod]
        public void GblProtocolLine_Construction()
        {
            var line = new GblProtocolLine();
        ...
        [TestMethod]
        public void GblProtocolLine_Decode_1()
        {
            var line = new GblProtocolLine();
            line.Decode
                (
        ...
        [TestMethod]
        public void GblProtocolLine_Decode_2()
        {
            var line = new GblProtocolLine();
            line.Decode
                (
        ...
        [TestMethod]
        public void GblProtocolLine_ToString_1()
        {
            var line = new GblProtocolLine();
            line.Decode
                (
