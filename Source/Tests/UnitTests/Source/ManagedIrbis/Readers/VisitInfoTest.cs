...
namespace UnitTests.ManagedIrbis.Readers
{
    ...
    public class VisitInfoTest
    {
        ...
        {
            return Parse(40, "^A84(2=Рус)5/Ц 27-422726^B1539325^CЦветаева М. И. Стихотворения^KФ302^V*^D20170930^1172914^E20171014^F20171028^GIBIS^HE00401004C75DB57^Isamo");
        }

        private Record _GetRecord()
        {
            var result = new Record();
            result.Fields.Add(Parse(906, "84(2=Рус)5"));
            result.Fields.Add(Parse(908, "Ц 27"));
            result.Fields.Add(Parse(700, "^AЦветаева^BМ. И.^GМарина Ивановна"));
            result.Fields.Add(Parse(215, "^A268"));
            result.Fields.Add(Parse(10, "^A5-7633-0120-X^D2.00"));
            result.Fields.Add(Parse(300, "(Поэтич. родники России). "));
            result.Fields.Add(Parse(920, "PAZK"));
            result.Fields.Add(Parse(900, "^B05"));
            result.Fields.Add(Parse(903, "84(2=Рус)5/Ц 27-000000-422728"));
            result.Fields.Add(Parse(101, "rus"));
            result.Fields.Add(Parse(9951, "1021780.jpg"));
            result.Fields.Add(Parse(9951, "1021781.jpg"));
            result.Fields.Add(Parse(907, "^CПК^A20121219^B^1"));
            result.Fields.Add(Parse(2012, "4"));
            result.Fields.Add(Parse(2013, "^aБО заимствовано^bRETRO^c421180"));
            result.Fields.Add(Parse(907, "^C^A20130128^B"));
            result.Fields.Add(Parse(907, "^CКР^A20131217^Bmiron"));
            result.Fields.Add(Parse(1119, "c791f88d-70d9-47d2-9dee-7a158d903a99"));
            result.Fields.Add(Parse(210, "^CПриволжское книжное изд-во^AСаратов^D1990"));
            result.Fields.Add(Parse(200, "^AСтихотворения. Проза^FМ. Цветаева ; сост. авт. послесл., с. 245-263, Е. П. Никитина"));
            result.Fields.Add(Parse(907, "^CКР^A20140421^Bертаевасб"));
            result.Fields.Add(Parse(910, "^B1546154^DФКХ^C20121107^A0^hE00401004C79A941"));
            result.Fields.Add(Parse(905, "^D3^F2^S1^21^J1"));
        ...
        public void VisitInfo_Parse_1()
        {
            ...
            Assert.IsNotNull(visit.UnknownSubFields);
            ...
            )
        {
            ...
            var second = bytes.RestoreObjectFromMemory<VisitInfo>();
        ...
        public void VisitInfo_Save_Read_1()
        {
            ...
            var array = VisitInfo.ReadFromFile(fileName);
        ...
        public void VisitInfo_Save_Read_2()
        {
            ...
            var array = bytes.RestoreArrayFromMemory<VisitInfo>();
            var second = array[0];
            _Compare(first, second);
        }
        ...
        public void VisitInfo_GetBookPrice_1()
        {
            ...
            var actual = visit.GetBookPrice(record);
        ...
        public void VisitInfo_GetBookPrice_2()
        {
            ...
            record.Fields.Add(Parse(910, "^A0^B1539325^C20121107^DФКХ^E3.00^HE00401004C75DB57"));
            var actual = visit.GetBookPrice(record);
        ...
        public void VisitInfo_GetBookPrice_3()
        {
            ...
            var record = _GetRecord();
            record.RemoveField(910);
            record.Fields.Add(Parse(910, "^A0^B1539325^C20121107^DФКХ^E4.00"));
            var actual = visit.GetBookPrice(record);
        ...
        {
            var record = _GetRecord();
            var actual = VisitInfo.GetBookYear(record);
