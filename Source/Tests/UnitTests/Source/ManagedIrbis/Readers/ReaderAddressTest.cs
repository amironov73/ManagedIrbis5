...
public class ReaderAddressTest
{
    ...
    {
        return Parse (ReaderAddress.Tag,
            "^A125075^BРоссийская Федерация^CМосква^Dул. Лесная^Eд. 5^Gподъезд 4^Hкв. 176");
    }
        ...
        )
    {
        ...
        if (first.UnknownSubFields is not null)
        {
    ...
    public void ReaderAddress_ToXml_1()
    {
        ...
        address = _GetAddress();
        Assert.AreEqual (
            "<address postcode=\"125075\" country=\"Российская Федерация\" city=\"Москва\" street=\"ул. Лесная\" building=\"д. 5\" entrance=\"подъезд 4\" apartment=\"кв. 176\" />",
            XmlUtility.SerializeShort (address));
    }
    ...
    public void ReaderAddress_ToJson_1()
    {
        ...
        address = _GetAddress();
        Assert.AreEqual (
            "{'postcode':'125075','country':'Российская Федерация','city':'Москва','street':'ул. Лесная','building':'д. 5','entrance':'подъезд 4','apartment':'кв. 176'}",
            JsonUtility.SerializeShort (address));
    }
    ...
    public void ReaderAddress_ToString_1()
    {
        ...
        address = _GetAddress();
        Assert.AreEqual ("125075, Российская Федерация, Москва, ул. Лесная, д. 5, подъезд 4, кв. 176",
            address.ToString());
    }
}
