    ...
    : Common.CommonUnitTest
{
    ...
    public void WssFile_ToXml_1()
    {
        ...
        Assert.AreEqual
            (
                "<wss name=\"951m.wss\"><items><item><tag>A</tag><title>Имя файла</title><input-mode>0</input-mode></item><item><tag>I</tag><title>URL (Адрес в Internet)</title><input-mode>1</input-mode><input-info>951.mnu</input-info></item></items></wss>",
                XmlUtility.SerializeShort (file)
            );
    }
    ...
    public void WssFile_ToJson_1()
    {
        ...
        Assert.AreEqual
            (
                "{'name':'951m.wss','items':[{'tag':'A','title':'Имя файла','input-mode':'0'},{'tag':'I','title':'URL (Адрес в Internet)','input-mode':'1','input-info':'951.mnu'}]}",
                JsonUtility.SerializeShort (file)
            );
    }
