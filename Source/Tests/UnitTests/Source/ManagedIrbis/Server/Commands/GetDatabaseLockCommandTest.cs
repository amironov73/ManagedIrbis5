...
{
    [TestClass]
    public sealed class GetDatabaseLockCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void GetDatabaseLockCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new GetDatabaseLockCommand (workData);
        ...
        public void GetDatabaseLockCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new GetDatabaseLockCommand (workData);
            command.Execute();
