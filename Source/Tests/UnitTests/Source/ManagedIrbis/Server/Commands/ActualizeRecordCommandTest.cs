...
{
    [TestClass]
    public sealed class ActualizeRecordCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void ActualizeRecordCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new ActualizeRecordCommand (workData);
        ...
        public void ActualizeRecordCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new ActualizeRecordCommand (workData);
            command.Execute();
