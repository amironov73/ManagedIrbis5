...
{
    [TestClass]
    public sealed class FullTextSearchCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void FullTextSearchCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new FullTextSearchCommand (workData);
        ...
        public void FullTextSearchCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new FullTextSearchCommand (workData);
            command.Execute();
