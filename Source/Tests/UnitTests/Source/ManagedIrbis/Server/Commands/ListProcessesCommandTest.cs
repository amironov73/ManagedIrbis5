...
{
    [TestClass]
    public sealed class ListProcessesCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void ListProcessesCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new ListProcessesCommand (workData);
        ...
        public void ListProcessesCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new ListProcessesCommand (workData);
            command.Execute();
