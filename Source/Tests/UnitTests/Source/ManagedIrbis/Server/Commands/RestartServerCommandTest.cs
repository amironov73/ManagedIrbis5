...
{
    [TestClass]
    public sealed class RestartServerCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void RestartServerCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new RestartServerCommand (workData);
        ...
        public void RestartServerCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new RestartServerCommand (workData);
            command.Execute();
