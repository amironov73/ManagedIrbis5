...
{
    [TestClass]
    public sealed class MaxMfnCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void MaxMfnCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new MaxMfnCommand (workData);
        ...
        public void MaxMfnCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new MaxMfnCommand (workData);
            command.Execute();
