...
{
    [TestClass]
    public sealed class FormatIsoGroupCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void FormatIsoGroupCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new FormatIsoGroupCommand (workData);
        ...
        public void FormatIsoGroupCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new FormatIsoGroupCommand (workData);
            command.Execute();
