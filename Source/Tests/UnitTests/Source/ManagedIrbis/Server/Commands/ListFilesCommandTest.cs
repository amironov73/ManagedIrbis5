...
{
    [TestClass]
    public sealed class ListFilesCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void ListFilesCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new ListFilesCommand (workData);
        ...
        public void ListFilesCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new ListFilesCommand (workData);
            command.Execute();
