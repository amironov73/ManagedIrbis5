...
{
    [TestClass]
    public sealed class CreateDictionaryCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void CreateDictionaryCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new CreateDictionaryCommand (workData);
        ...
        public void CreateDictionaryCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new CreateDictionaryCommand (workData);
            command.Execute();
