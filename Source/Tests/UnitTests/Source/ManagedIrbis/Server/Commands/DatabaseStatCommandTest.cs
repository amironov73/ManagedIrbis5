...
{
    [TestClass]
    public sealed class DatabaseStatCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void DatabaseStatCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new DatabaseStatCommand (workData);
        ...
        public void DatabaseStatCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new DatabaseStatCommand (workData);
            command.Execute();
