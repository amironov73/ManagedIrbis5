...
{
    [TestClass]
    public sealed class DatabaseInfoCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void DatabaseInfoCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new DatabaseInfoCommand (workData);
        ...
        public void DatabaseInfoCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new DatabaseInfoCommand (workData);
            command.Execute();
