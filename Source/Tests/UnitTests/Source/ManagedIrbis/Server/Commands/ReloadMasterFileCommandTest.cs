...
{
    [TestClass]
    public sealed class ReloadMasterFileCommandTest
        : Common.CommonUnitTest
    {
        [TestMethod]
        [Description ("Конструктор")]
        public void ReloadMasterFileCommand_Construction_1()
        {
            var workData = new WorkData();
            var command = new ReloadMasterFileCommand (workData);
        ...
        public void ReloadMasterFileCommand_Execute_1()
        {
            var workData = new WorkData();
            var command = new ReloadMasterFileCommand (workData);
            command.Execute();
