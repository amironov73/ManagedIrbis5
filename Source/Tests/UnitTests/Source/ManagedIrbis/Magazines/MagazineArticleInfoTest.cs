...
namespace UnitTests.ManagedIrbis.Magazines
{
        ...
        : CommonMagazineTest
    {
        private Record _GetAspRecord()
        {
            ...
            result.Fields.Add (Parse (463,
                "^CУсольская городская газета^J2017^S1, 4^0a-фот.^H№ 42 (19 окт.)^WУ761/2017/42"));
            ...
            result.Fields.Add (Parse (606,
                "^3IRPL-011689-739926^AУсолье-Сибирское, город (Иркутская область)^BСоциально-экономическое развитие"));
            result.Fields.Add (Parse (606,
                "^3IRPL-0000020631-790781^AМестное самоуправление^GУсолье-Сибирское, город (Иркутская область)"));
        ...
        private Record _GetIssueRecord()
        {
            ...
            result.Fields.Add (Parse (951,
                "^Ausol'skaja_gorodskaja_gazeta_2017_042.pdf^TПолный текст^N28^H01^120171030^229601060"));
            ...
            result.Fields.Add (Parse (922,
                "^FКоролева О.^?Ольга^CЧетыре новых руководителя в администрации города^41, 4^0a-фот.^GО. Королева"));
            result.Fields.Add (Parse (922,
                "^FДроздовская Г.^?Галина^CПоэтический марафон есенинских строк^48^0a-фот.^GГ. Дроздовская"));
        ...
        private Record _GetBookRecord()
        {
            ...
            result.Fields.Add (Parse (200,
                "^aС любовью к Родине^eпублицистика, повесть, рассказы^fВалентин Распутин ; [авт. проекта и отв. за вып. Л. В. Бабин ; ред. С. Вихристюк ; худож. С. Богатов ; фот.: А. Бызов, В. Поляков]"));
            ...
            result.Fields.Add (Parse (606,
                "^3IRPL-006935-660479^aРаспутин Валентин Григорьевич (писатель; 15.03.1937-14.03.2015)^bПроизведения"));
            result.Fields.Add (Parse (6629, "RASP1"));
            result.Fields.Add (Parse (661, "^a2001^b2001"));
            result.Fields.Add (Parse (6628, " 1. 1. 2"));
            result.Fields.Add (Parse (330,
                "^gавт. предисл. Валентин Распутин^fРаспутин В. Г.^?Валентин Григорьевич^q080 авт. предисл.^cНа перевале видно лучше^44-6"));
            result.Fields.Add (Parse (330,
                "^gБорис Говорин ; беседовал Валентин Распутин^fГоворин А.^q070 авт.^2Распутин В. Г.^,Валентин Григорьевич^cМестная власть и местный народ^eинтервью  с губернатором Иркут. обл.^48-35"));
            result.Fields.Add (Parse (330,
                "^gБорис Говорин ; беседовал Валентин Распутин^fГоворин Б. А.^?Борис Александрович^q070 авт.^2Распутин В. Г.^,Валентин Григорьевич^cДеньги могут многое, но не все. В России - не все...^eинтервью  с губернатором Иркут. обл.^436-54"));
            result.Fields.Add (Parse (330,
                "^gавт. предисл. Л. Бабин^fБабин Л.^q080 авт. предисл.^cПожар^eповесть^456-112"));
        ...
        public void MagazineArticleInfo_ToXml_1()
        {
            ...
            article = MagazineArticleInfo.ParseAsp (_GetAspRecord());
            Assert.AreEqual (
                "<article><author familyName=\"Королева\" initials=\"О.\" fullName=\"Ольга\" cantBeInverted=\"false\" /><title title=\"Четыре новых руководителя в администрации города\" first=\"О. Королева\" /><source><title>Усольская городская газета</title><year>2017</year><position>1, 4</position><illustrations>a-фот.</illustrations><secondLevelNumber>№ 42 (19 окт.)</secondLevelNumber><index>У761/2017/42</index></source></article>",
                XmlUtility.SerializeShort (article));
        }
        ...
        public void MagazineArticleInfo_ToJson_1()
        {
            ...
            article = MagazineArticleInfo.ParseAsp (_GetAspRecord());
            Assert.AreEqual (
                "{\"authors\":[{\"familyName\":\"\\u041A\\u043E\\u0440\\u043E\\u043B\\u0435\\u0432\\u0430\",\"initials\":\"\\u041E.\",\"fullName\":\"\\u041E\\u043B\\u044C\\u0433\\u0430\",\"cantBeInverted\":false}],\"title\":{\"title\":\"\\u0427\\u0435\\u0442\\u044B\\u0440\\u0435 \\u043D\\u043E\\u0432\\u044B\\u0445 \\u0440\\u0443\\u043A\\u043E\\u0432\\u043E\\u0434\\u0438\\u0442\\u0435\\u043B\\u044F \\u0432 \\u0430\\u0434\\u043C\\u0438\\u043D\\u0438\\u0441\\u0442\\u0440\\u0430\\u0446\\u0438\\u0438 \\u0433\\u043E\\u0440\\u043E\\u0434\\u0430\",\"first\":\"\\u041E. \\u041A\\u043E\\u0440\\u043E\\u043B\\u0435\\u0432\\u0430\",\"unknown\":[]},\"sources\":[{\"title\":\"\\u0423\\u0441\\u043E\\u043B\\u044C\\u0441\\u043A\\u0430\\u044F \\u0433\\u043E\\u0440\\u043E\\u0434\\u0441\\u043A\\u0430\\u044F \\u0433\\u0430\\u0437\\u0435\\u0442\\u0430\",\"year\":\"2017\",\"position\":\"1, 4\",\"illustrations\":\"a-\\u0444\\u043E\\u0442.\",\"secondLevelNumber\":\"\\u2116 42 (19 \\u043E\\u043A\\u0442.)\",\"index\":\"\\u0423761/2017/42\"}]}",
                JsonUtility.SerializeShort (article));
        }
