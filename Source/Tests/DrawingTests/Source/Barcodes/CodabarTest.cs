...
namespace UnitTests.AM.Drawing.Barcodes
{
        ...
        : DrawingTests.CommonUnitTest
    {
        ...
        {
            var barcode = new Codabar();
            var expected = "10110010010110010101010101100101010110010101011001010010110101010100110101011001011001010101010010110101010011010010101101100101010100101101011010100101011001001";
            var data = new BarcodeData
            {
                Message = "A31117013206375A"
            };
