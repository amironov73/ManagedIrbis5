...
public sealed class PlainTextFormTest
    : IFormsTest
{
    ...
    {
        using var form = new PlainTextForm
        {
            Size = new Size (800, 600)
        };

        form.Text = "Значимость этих проблем настолько очевидна, что постоянный "
