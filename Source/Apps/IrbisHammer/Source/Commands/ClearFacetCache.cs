...
/* ClearFacetCache.cs -- очистка кеша фасетов
...
/// <summary>
/// Очистка кеша фасетов.
/// </summary>
internal sealed class ClearFacetCache
    : ToolCommand
{
    #region ToolCommand members

    /// <inheritdoc cref="ToolCommand.CommandName"/>
    public override string? CommandName => "Очистка кеша фасетов";
