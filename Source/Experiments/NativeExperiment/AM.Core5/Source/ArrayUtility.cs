...
public static class ArrayUtility
{
    ...
    {
        Sure.NotNull (firstArray);
        Sure.NotNull (secondArray);
        Sure.NonNegative (firstOffset);
        Sure.NonNegative (secondOffset);
        ...
        )
    {
        ...
        var result = array.GetSlice (offset, count);
