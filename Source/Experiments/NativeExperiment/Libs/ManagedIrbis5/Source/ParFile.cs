        ...
        IVerifiable
{
    ...
    {
        var verifier = new Verifier<ParFile> (this, throwOnError);

        verifier
            .NotNullNorEmpty (XrfPath)
            .NotNullNorEmpty (MstPath)
            .NotNullNorEmpty (CntPath)
            .NotNullNorEmpty (N01Path)
            .NotNullNorEmpty (N02Path)
            .NotNullNorEmpty (L01Path)
            .NotNullNorEmpty (L02Path)
            .NotNullNorEmpty (IfpPath)
            .NotNullNorEmpty (AnyPath)
            .NotNullNorEmpty (PftPath);
