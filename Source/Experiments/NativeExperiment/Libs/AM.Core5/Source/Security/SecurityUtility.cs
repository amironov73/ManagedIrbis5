...
#pragma warning disable SYSLIB0041 // "Rfc2898DeriveBytes.Rfc2898DeriveBytes(string, byte[])" является устаревшим: 'The default hash algorithm and iteration counts in Rfc2898DeriveBytes constructors are outdated and insecure. Use a constructor that accepts the hash algorithm and the number of iterations.'
