...
dotnet pack    --no-restore --no-build --configuration Release --include-symbols --include-source --output NuGet Source/ManagedIrbis5-publish.sln
dotnet pack    --no-restore --no-build --configuration Release --include-symbols --include-source --output NuGet Source/Libs/TinyClient/TinyClient.csproj
